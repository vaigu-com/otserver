...
quest
	...
	:Questlog(function()
		Quests[NextQuestId()] = {
			name = "Prodigal Son",
			startStorageId = Storage.ProdigalSon.Localizer,
			startStorageValue = 1,
			missions = {
				[1] = {
	...
	:Script(function(storageToRequiredState)
		...
		local mainGateTile = MoveEvent()
		function mainGateTile.onStepIn(player, item, toPosition, fromPosition)
			local czeslawQuestState = player:getStorageValue(Storage.ChesterTheDwarf.Mission04)
			if czeslawQuestState < requiredCzeslawQuestState then
				return
			end

			local synMarnotrawnyState = player:getStorageValue(Storage.ProdigalSon.Mission01)
	...
	:State(QuestState.ProdigalSon.Mission01.ChesterSpeakingAboutJanuszex)
	...
	:State(QuestState.ProdigalSon.Mission01.YouAreLookingForJanuszex)
	:Dialog("Chester the Dwarf", {
		[{ "train", "pociagiem" }] = {
	...
	:State(QuestState.ProdigalSon.Mission02.FindForeman)
	...
	:State(QuestState.ProdigalSon.Mission02.PaintHammers)
	:StartupItems({
		{
			pos = { -90, -68, 2 },
	...
	:State(QuestState.ProdigalSon.Mission02.MakingCalculators)
	:StartupItems({
		{
			pos = { -77, 3, -1 },
	...
	:State(QuestState.ProdigalSon.Mission02.MakingPliers)
	:StartupItems({
		{
			pos = { -98, -36, 1 },
			id = SYN_MARNOTRAWNY_NORMAL_ITEMS.stonePile,
	...
	:State(QuestState.ProdigalSon.Mission03.TalkToHearAboutDuties)
	:Dialog("Henry the Foreman", {
		[{ GREET }] = {
	...
	:State(QuestState.ProdigalSon.Mission03.KillAreczekLeader)
	:StartupItems({
	...
	:State(QuestState.ProdigalSon.Mission03.ReportKillngAreczekLeader)
	:Dialog("Henry the Foreman", {
		[{ "mission" }] = {
	...
	:State(QuestState.ProdigalSon.Mission04.FindingEristicsBooks)
	:StartupItems({
		{
			pos = { -50, -5, 1 },
			id = 2438,
	...
	:State(QuestState.ProdigalSon.Mission04.DupingConferencePeople)
	:StartupNpcs({
	...
	:State(QuestState.ProdigalSon.Mission05.YouHaveAccessToNorthMines)
	:Dialog("Henry the Foreman", {
		[{ "mission" }] = {
	...
	:State(QuestState.ProdigalSon.Mission05.FindingDwarfNecklace)
	:StartupItems({
		{
			pos = { -40, -270, 5 },
			id = 4169,
	...
	:State(QuestState.ProdigalSon.Mission05.FoundNecklaceAskForNewMission)
	:Dialog("Henry the Foreman", {
		[{ "mission" }] = {
	...
	:State(QuestState.ProdigalSon.Mission05.CheckingOnSilo)
	:StartupItems({
		{
			pos = { 74, -82, 2 },
			id = 843,
	...
	:State(QuestState.ProdigalSon.Mission05.EscortingFredi)
	:StartupItems({
		{
			pos = { 104, -150, 4 },
			id = 5468,
	...
	:State(QuestState.ProdigalSon.Mission06.HenryJustTalkedWithFredi)
	:Dialog("Henry the Foreman", {
		[{ "mission" }] = {
	...
	:State(QuestState.ProdigalSon.Mission06.KilledImperator)
	:Dialog("Henry the Foreman", {
		[{ "mission" }] = {
	...
	:State(QuestState.ProdigalSon.Mission06.ReportToChester)
	:Dialog("Chester the Dwarf", {
