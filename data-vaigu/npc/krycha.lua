...
npcHandler:setMessage(MESSAGE_GREET, "Hejze! Sprawdz moje nowe receptury i skladniki, wpisujac {trade}.")
-- npcHandler:setMessage(MESSAGE_GREET_ENG, 'Hello! Check out my new recipes, say {trade}.')
