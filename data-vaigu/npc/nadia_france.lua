local internalNpcName = "Nadia France"
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if table.contains({ "krag", "kregi", "circles", "cromlech" }, msg) and player:getStorageValue(Storage.PathOfTheUndead.Mission01) == 2 then
...
npcHandler:setMessage(MESSAGE_GREET, "Slalom Alejkom |PLAYERNAME|. Sytuacja na pustyni stabilna.")
-- npcHandler:setMessage(MESSAGE_GREET_ENG, 'Hello |PLAYERNAME|. I can sell you some equipment for mages. Say {trade} to see my offer.')
