...
local function creatureSayCallback(npc, creature, type, message)
	...
	if table.contains({ "zlodziej", "thief" }, message) and player:getStorageValue(Storage.IKEAForTheBold.State) == 7 then
	...
	elseif table.contains({ "zlodziej", "thief", "nagroda", "reward", "drwal" }, message) and player:getStorageValue(Storage.IKEAForTheBold.State) == 13 then
		if player:getLevel() >= 35 then
			...
			player:setStorageValue(Storage.IKEAForTheBold.State, 14)
	...
	elseif table.contains({ "mission", "misja" }, message) and player:getStorageValue(Storage.StickyBeginning.RewardState) == 4 then
	...
	elseif table.contains({ "mission", "misja" }, message) and player:getStorageValue(Storage.StickyBeginning.WoodDelivery) == 5 then
		player:setStorageValue(Storage.StickyBeginning.WoodDelivery, 6)
	...
	elseif table.contains({ "mission", "misja" }, message) and player:getStorageValue(Storage.StickyBeginning.WoodDelivery) == 3 then
		player:setStorageValue(Storage.IKEAForTheBold.State, 0)
		player:setStorageValue(Storage.StickyBeginning.WoodDelivery, 4)
	...
	elseif table.contains({ "mission", "misja" }, message) and player:getStorageValue(Storage.StickyBeginning.Discernment) == 12 and player:getStorageValue(Storage.StickyBeginning.WoodDelivery) < 1 then
		player:setStorageValue(Storage.StickyBeginning.WoodDelivery, 1) -- nowa misja
	...
	elseif table.contains({ "mission", "misja" }, message) and player:getStorageValue(Storage.StickyBeginning.Discernment) < 2 then
		player:setStorageValue(Storage.StickyBeginning.Discernment, 2)
		npcHandler:say(getPlayerLanguage(player) == "PL" and {
	...
	elseif table.contains({ "catch", "zlapac" }, message) and npcHandler:getTopic(playerId) == 2 then
		player:setStorageValue(Storage.IKEAForTheBold.State, 8)
		npcHandler:say(
