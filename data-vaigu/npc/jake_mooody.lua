local internalNpcName = "Jake Mooody"
...
npcHandler:setMessage(MESSAGE_GREET, "No dzien dobry, jak tam? Wszyscy zdrowi w domu? Aby sie ze mna wymieniac, napisz {wymiana}.")
-- npcHandler:setMessage(MESSAGE_GREET_ENG, 'asdfasfdasfdas')
