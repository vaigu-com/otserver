...
local dialogs = {
	...
	[Storage.KingOfRatsHQ.Localizer] = {
		[Storage.KingOfRatsHQ.QuestState] = {
			[{ min = State.KingOfRatsHQ.ZeroArtifactsCollected, max = State.KingOfRatsHQ.AllArtifactsCollected }] = {
	...
	[Storage.TheaterOfCheapThrills.Localizer] = {
	...
	[Storage.SafetyAndOccupationalHygiene.Localizer] = {
		[Storage.SafetyAndOccupationalHygiene.Mission01] = {
			[1] = {
				[{ "mission" }] = {
					...
					nextState = {
						[Storage.SafetyAndOccupationalHygiene.State] = 2,
	...
	[Storage.FourActTragedy.Localizer] = {
		...
		[Storage.FourActTragedy.Mission04] = {
			[1] = { [{ "mission" }] = {
				text = "Look out in the eastern Kongo.",
			} },
			[2] = {
				[{ "mission" }] = {
		...
		[Storage.FourActTragedy.Mission06] = {
			[4] = {
				[{ "mission" }] = {
	...
	[Storage.PerIustitiaAdAstra.State] = {
		[Storage.PerIustitiaAdAstra.Mission01] = {
			[1] = {
				[{ ANY_MESSAGE }] = {
					text = "As i said, go to the Karaiby.",
				},
			},
		},
	},
