...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif table.contains({ "mission", "misja", "pomoc", "help" }, message) then
		...
		elseif player:getStorageValue(Storage.TheaterOfCheapThrills.State) == 16 and player:getStorageValue(Storage.ToCarryThePigs.BeLikeSchwarzenegger) == 4 then
			player:setStorageValue(Storage.TheaterOfCheapThrills.State, 17)
		...
		elseif player:getStorageValue(Storage.ToCarryThePigs.BeLikeSchwarzenegger) < 1 then
			...
			elseif player:getStorageValue(Storage.TheaterOfCheapThrills.State) == 16 and message ~= "pomoc" and message ~= "help" then
