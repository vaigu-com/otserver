	...
	[Storage.ThreeSramatiansAndTheDragon.Questline] = {
		[3] = {
			...
			[{ "neyghboor", "somsiedzie" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 4,
		...
		[4] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 5,
		...
		[6] = {
			[{ "mission", "rum" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 7,
		...
		[8] = {
			...
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 9,
		...
		[13] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 14,
		...
		[16] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 17,
		...
		[18] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 19,
		...
		[19] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 20,
		...
		[20] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.ThreeSramatiansAndTheDragon.Questline] = 21,
