	...
	[Storage.SafetyAndOccupationalHygiene.Questline] = {
		[2] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.SafetyAndOccupationalHygiene.Questline] = 3,
		...
		[4] = {
			[{ "mission", "cuckurse", "cucklatwa" }] = {
				...
				nextState = {
					[Storage.SafetyAndOccupationalHygiene.Questline] = 5,
		...
		[5] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.SafetyAndOccupationalHygiene.Questline] = 6,
		...
		[6] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.SafetyAndOccupationalHygiene.Questline] = 7,
		...
		[8] = {
			...
			[{ "axe", "sword", "mace", "bow", "rod", "wand" }] = {
				...
				nextState = {
					[Storage.SafetyAndOccupationalHygiene.Questline] = 9,
		...
		[9] = {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.SafetyAndOccupationalHygiene.Questline] = 10,
	...
	[Storage.FourActTragedy.Questline] = {
		[2] = {
			...
			[{ "byl", "was" }] = {
				...
				nextState = {
					[Storage.FourActTragedy.Questline] = 3,
