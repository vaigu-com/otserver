...
npcHandler:setMessage(MESSAGE_GREET, "Czesc, tu Stephen. Sprzedaje rozmaite narzedzia. Napisz {trade}, aby zobaczyc oferte.")
-- npcHandler:setMessage(MESSAGE_GREET_ENG, 'Hello, im Stephen. I {trade} with various equipment.')
