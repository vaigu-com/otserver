...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "trade") then
		npcHandler:say({ "I have creature products for the imbuements {strike}, {vampirism} and {void}. Make your choice, please! I also offer equipment in exchange for your gold {tokens}." }, npc, creature)
