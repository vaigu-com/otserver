local internalNpcName = "Hermione"
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if table.contains({ "krag", "kregi", "circles", "cromlech" }, message) and player:getStorageValue(Storage.PathOfTheUndead.Mission01) == 2 then
