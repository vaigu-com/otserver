...
local function creatureSayCallback(npc, creature, type, message)
	...
	if table.contains({ "mission", "misja", "misje" }, message) then
		if player:getStorageValueByKey(Storage.TheInquisition.Questline) == 6 then
			if player:getStorageValueByKey(Storage.TheInquisition.StorkusVampiredust) < 0 then
				player:setStorageValueByKey(Storage.TheInquisition.StorkusVampiredust, 0)
			end
			...
			elseif player:getStorageValueByKey(Storage.TheInquisition.StorkusVampiredust) == 20 then
				...
				player:setStorageValueByKey(Storage.TheInquisition.Questline, 7)
				player:setStorageValueByKey(Storage.TheInquisition.Mission03, 2) -- The Inquisition Questlog- "Mission 3: Vampire Hunt"
			end
		elseif player:getStorageValueByKey(Storage.TheInquisition.Questline) == 7 then
			...
			player:setStorageValueByKey(Storage.TheInquisition.Questline, 8)
			player:setStorageValueByKey(Storage.TheInquisition.Mission03, 3) -- The Inquisition Questlog- "Mission 3: Vampire Hunt"
			npcHandler:setTopic(playerId, 0)
		elseif player:getStorageValueByKey(Storage.TheInquisition.Questline) == 8 or player:getStorageValueByKey(Storage.TheInquisition.Questline) == 9 then
			if player:removeItem(7924, 1) then
				...
				player:setStorageValueByKey(Storage.TheInquisition.Questline, 10)
				player:setStorageValueByKey(Storage.TheInquisition.Mission03, 5) -- The Inquisition Questlog- "Mission 3: Vampire Hunt"
			else
	...
	elseif MsgContains(message, "vampire lord token") and player:getStorageValueByKey(Storage.TheInquisition.Questline) == 10 then
		if player:getStorageValueByKey(Storage.VampireHunter.Rank) < 1 then
		...
		elseif player:getStorageValueByKey(Storage.VampireHunter.Rank) == 1 then
			npcHandler:say(getPlayerLanguage(player) == "PL" and "Chcesz mi przekazac wampirzy zeton?" or "Would ye' like to give me vampire tokens?", npc, creature)
			npcHandler:setTopic(playerId, 4)
		elseif player:getStorageValueByKey(Storage.VampireHunter.Rank) == 2 then
			npcHandler:say(getPlayerLanguage(player) == "PL" and "Chcesz mi przekazac wampirzy zeton?" or "Would ye' like to give me vampire tokens?", npc, creature)
			npcHandler:setTopic(playerId, 5)
		elseif player:getStorageValueByKey(Storage.VampireHunter.Rank) == 3 then
			npcHandler:say(getPlayerLanguage(player) == "PL" and "Chcesz mi przekazac wampirzy zeton?" or "Would ye' like to give me vampire tokens?", npc, creature)
			npcHandler:setTopic(playerId, 6)
		elseif player:getStorageValueByKey(Storage.VampireHunter.Rank) == 4 then
			npcHandler:say(getPlayerLanguage(player) == "PL" and "Chcesz mi przekazac wampirzy zeton?" or "Would ye' like to give me vampire tokens?", npc, creature)
			npcHandler:setTopic(playerId, 7)
		elseif player:getStorageValueByKey(Storage.VampireHunter.Rank) == 5 then
			npcHandler:say(getPlayerLanguage(player) == "PL" and "Chcesz mi przekazac wampirzy zeton?" or "Would ye' like to give me vampire tokens?", npc, creature)
	...
	elseif MsgContains(message, "yes") or MsgContains(message, "tak") then
		if npcHandler:getTopic(playerId) == 1 then
			...
			requiredCount = 20 - player:getStorageValueByKey(Storage.TheInquisition.StorkusVampiredust)
			if count > requiredCount then
				count = requiredCount
			end
			player:setStorageValueByKey(Storage.TheInquisition.StorkusVampiredust, player:getStorageValueByKey(Storage.TheInquisition.StorkusVampiredust) + count)
		...
		elseif npcHandler:getTopic(playerId) == 3 then
			if player:removeItem(8192, 1) then
				...
				player:setStorageValueByKey(Storage.VampireHunter.Rank, 1)
		...
		elseif npcHandler:getTopic(playerId) == 4 then
			if player:removeItem(8192, 4) then
				...
				player:setStorageValueByKey(Storage.VampireHunter.Rank, 2)
		...
		elseif npcHandler:getTopic(playerId) == 5 then
			if player:removeItem(8192, 5) then
				...
				player:setStorageValueByKey(Storage.VampireHunter.Rank, 3)
		...
		elseif npcHandler:getTopic(playerId) == 6 then
			if player:removeItem(8192, 10) then
				...
				player:setStorageValueByKey(Storage.VampireHunter.Rank, 4)
		...
		elseif npcHandler:getTopic(playerId) == 7 then
			if player:removeItem(8192, 30) then
				...
				player:setStorageValueByKey(Storage.VampireHunter.Rank, 5)
