...
local function creatureSayCallback(npc, creature, type, message)
	...
	if table.contains({ "walker", "jezyk", "papier", "list" }, message) and player:getStorageValue(Storage.ToCarryThePigs.HalfTurnKick) == 2 and player:getItemCount(22160) > 0 then
		player:setStorageValue(Storage.ToCarryThePigs.HalfTurnKick, 3)
