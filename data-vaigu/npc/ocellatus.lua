...
local function creatureSayCallback(npc, creature, type, message)
	...
	}, message) and player:getStorageValue(Storage.OcellatusXD.Tickets) == 4 then
	...
	elseif MsgContains(message, "yes") or MsgContains(message, "tak") then
		if player:getStorageValue(Storage.OcellatusXD.Tickets) < 1 and npcHandler:getTopic(playerId) == 1 then
			player:setStorageValue(Storage.OcellatusXD.Tickets, 1)
		...
		if player:getStorageValue(Storage.OcellatusXD.Tickets) == 3 and npcHandler:getTopic(playerId) == 2 then
			player:setStorageValue(Storage.OcellatusXD.Tickets, 4)
	...
	elseif table.contains({ "mission", "misja", "misje" }, message) then
		if player:getStorageValue(Storage.OcellatusXD.Tickets) < 1 then
		...
		elseif player:getStorageValue(Storage.OcellatusXD.Tickets) == 1 then
		...
		elseif player:getStorageValue(Storage.OcellatusXD.Tickets) == 2 then
			if player:getItemCount(28818) > 0 then
				if player:getLevel() >= 20 then
					player:setStorageValue(Storage.OcellatusXD.Tickets, 3)
		...
		elseif player:getStorageValue(Storage.OcellatusXD.Tickets) == 3 then
			npcHandler:say(getPlayerLanguage(player) == "PL" and {
			...
			npcHandler:setTopic(playerId, 2)
		elseif player:getStorageValue(Storage.OcellatusXD.Tickets) == 4 then
		...
		elseif player:getStorageValue(Storage.OcellatusXD.Tickets) == 5 then
	...
	elseif table.contains({ "zupa", "skrzydelka", "zarcie", "food" }, message) and player:getStorageValue(Storage.OcellatusXD.Tickets) == 4 then
		if player:getItemCount(9081) > 0 and player:getItemCount(9079) > 0 then
			player:setStorageValue(Storage.OcellatusXD.Tickets, 5)
