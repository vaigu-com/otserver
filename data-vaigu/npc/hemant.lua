...
npcHandler:setMessage(MESSAGE_GREET, "Czesc, ja jestem Hemant. Sprzedaje akcesoria pomagajace w kopaniu grobow i zwiedzaniu krypt. Napisz {trade}, zeby sie ze mna powymieniac.")
-- npcHandler:setMessage(MESSAGE_GREET_ENG, 'Hello, I am Hemant. My offer contains work and exploring equipment. Ask about {trade} to see my offer.')
