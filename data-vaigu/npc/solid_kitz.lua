...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif table.contains({
		...
		"camp",
		"oboz",
	}, message) and player:getStorageValue(Storage.TheaterOfCheapThrills.State) == 17 then
	...
	elseif table.contains({ "yes", "tak" }, message) and player:getStorageValue(Storage.TheaterOfCheapThrills.State) == 17 and npcHandler:getTopic(playerId) == 1 then
		player:setStorageValue(Storage.TheaterOfCheapThrills.State, 18)
	...
	elseif table.contains({ "no", "nie" }, message) and player:getStorageValue(Storage.TheaterOfCheapThrills.State) == 17 and npcHandler:getTopic(playerId) == 1 then
		player:setStorageValue(Storage.TheaterOfCheapThrills.State, 18)
		player:setStorageValue(Storage.TheaterOfCheapThrills.Mission06, 4)
