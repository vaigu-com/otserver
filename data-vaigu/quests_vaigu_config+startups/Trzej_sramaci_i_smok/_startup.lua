	...
	local startupRewardsStatic = {
		{
			...
			uid = 1000,
			requiredState = { [Storage.ThreeSramatiansAndTheDragon.State] = 5 },
			nextState = { [Storage.ThreeSramatiansAndTheDragon.State] = 6, [Storage.ThreeSramatiansAndTheDragon.Mission03] = 4 },
		...
		},
		{
			...
			requiredState = { [Storage.ThreeSramatiansAndTheDragon.State] = 15 },
		},
		{
			pos = { 6814, 600, 12 },
			id = 11809,
			...
			uid = 1000,
			requiredState = { [Storage.ThreeSramatiansAndTheDragon.Rewards.rune1] = -1, [Storage.ThreeSramatiansAndTheDragon.State] = 21 },
		...
		},
		{
			...
			uid = 1000,
			requiredState = { [Storage.ThreeSramatiansAndTheDragon.Rewards.rune2] = -1, [Storage.ThreeSramatiansAndTheDragon.State] = 21 },
		...
		},
		{
			...
			uid = 1000,
			requiredState = { [Storage.ThreeSramatiansAndTheDragon.Rewards.rune3] = -1, [Storage.ThreeSramatiansAndTheDragon.State] = 21 },
