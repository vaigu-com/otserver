return {
	["The Fur Gang in Siberia has launched Operation Degeneration at the Dwarf camp near the mine. A bloody massacre is guaranteed."] = "The Fur Gang in Siberia has launched Operation Degeneration at the Dwarf camp near the mine. A bloody massacre is guaranteed.",
	["Borderland nomads are blessing the pyramids with their so-called cultural enrichment. This is hybrid warfare!"] = "Borderland nomads are blessing the pyramids with their so-called cultural enrichment. This is hybrid warfare!",
	["Shitskins are storming the border fence, abducting women to take them to Dubai. The pyramid of the Hurghada are in grave danger!"] = "Shitskins are storming the border fence, abducting women to take them to Dubai. The pyramid of the Hurghada are in grave danger!",
	["Knurowo is in trouble! A band of Amazons has attacked the town in search of breeding bulls and women's lingerie. Residents are barricading themselves in their homes — someone, please help them!"] = "Knurowo is in trouble! A band of Amazons has attacked the town in search of breeding bulls and women's lingerie. Residents are barricading themselves in their homes — someone, please help them!",
	["The jokes are over — deadly war golems have joined the rebellion. Fight or flee, unless you want to be stoned to death!"] = "The jokes are over — deadly war golems have joined the rebellion. Fight or flee, unless you want to be stoned to death!",
	["The enraged golems have emerged from the depths. We strongly advise all citizens to avoid the vicinity of the mine — this uprising will not stop at burning tires. Flying boulders are imminent."] = "The enraged golems have emerged from the depths. We strongly advise all citizens to avoid the vicinity of the mine — this uprising will not stop at burning tires. Flying boulders are imminent.",
	...
	["Primordial evil is awakening deep in the mines of Syberia."] = "Primordial evil is awakening deep in the mines of Syberia.",
	["Demonic entities begin to appear in the deepest mines of Syberia."] = "Demonic entities begin to appear in the deepest mines of Syberia.",
	["The Demonic Master has revealed himself in the mines of Syberia"] = "The Demonic Master has revealed himself in the mines of Syberia",
	["Whispers of dark power echo through the Byggoshch caverns."] = "Whispers of dark power echo through the Byggoshch caverns.",
	["Shadows move unnaturally as demonic forces gather in Byggoshch."] = "Shadows move unnaturally as demonic forces gather in Byggoshch.",
	["Zoralurk glowy eyes pierce the darkness. She is ready to strike!"] = "Zoralurk glowy eyes pierce the darkness. She is ready to strike.",
	["Strange footsteps can be heard in the north of the Hurghada desert."] = "Strange footsteps can be heard in the north of the Hurghada desert.",
