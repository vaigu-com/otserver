return {
	...
	["King of the Crypt"] = "His main power is ever increasing damage when focusing on same target. You should make him change his target if damage is overwhelming. If you do, he will summon a bomb that will deal massive damage to everyone in arena. However, if you hug the bomb, this damage will instead be split between all people who stand next to it.\nHe will also announce and fire dark energy beams. Be careful, as there will be more beams when he is below 50% health.\nHis last ability is summoning volatile undeads. They dont do anything special other than exploding in big damage.",
