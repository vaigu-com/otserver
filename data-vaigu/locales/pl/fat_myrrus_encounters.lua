return {
	["Kraken"] = "Walka zaczyna sie od tego, ze dowodca druzyny dostrzega w lunecie, ze wlasnie zaatakowal was kraken!\nJego macki proboja zniszczyc poklad statku. Zablokujcie je swoim cialem, a wasza lajba przezyje dluzej.\nW tym samym czasie mozecie atakowac niektore z jego macek. To oslabi go w nastepnej fazie.\nGdy ilosc macek atakujacych poklad bedzie niepolicznalna, wasz statek zamieni sie w dryfujace deski. Kraken wynurzy wtedy swe plugawe oblicze, a wy bedziecie mogli stawic mu czola twarza w twarz.",
	["Zul Szczurow"] = "Zul Szczurow nic nie moze. Niezpieczni natomiast sa jego pacholkowie - Zule Zulow.\nZul Zulow ma malo zycia, ale przy smierci przywoluje dwoch braci. Badz ostrozny, gdyz ich bardzo latwo jest ich namnozyc!\nIm wiecej czasu minelo od ostatniej smierci Zula Zulow tym wiecej obrazen zadaja inni Zule.",
	...
	["Krol Krypty"] = "Jego najwieksza moca jest zwiekszanie swojej sily przy atakowaniu wciaz tego samego celu. Powinniscie zmieniac sie co jakis czas. Przy kazdej takiej zmianie krol wyczarowuje bombe, ktora zadaje ogromne obrazenia wszystkim na arenie. Zeby temu zapobiec, stancie przy samej bombie - wtedy obrazenia zostana rownomiernie rozdzielone miedzy osoby stojace obok bomby.\nKrol przywoluje tez szkieletory, ktore wybuchaja przy smierci.",
