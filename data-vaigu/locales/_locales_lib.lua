...
TRANSLATION_TABLES = {
	["PL"] = {
		...
		[Storage.TheThreeSramatiansAndTheDragon.Questline] = loadStrings("trzej_sramaci_i_smok_pl.lua"),
		[Storage.AssassinsCreedSquurvaali.Questline] = loadStrings("assassins_creed_skurwoala_pl.lua"),
		[Storage.SafetyAndOccupationalHygiene.Questline] = loadStrings("bezpieczenstwo_i_higiena_pracy_pl.lua"),
		[Storage.ChesterTheDwarf.Questline] = loadStrings("czeslaw_krasnolud_pl.lua"),
		[Storage.DesertQuestGhosts.Questline] = loadStrings("desert_quest_ghosts_pl.lua"),
		[Storage.KingOfRatsHQ.Questline] = loadStrings("krol_szczurow_hub_pl.lua"),
		[Storage.PerIustitiaAdAstra.Questline] = loadStrings("per_iustitia_ad_astra_pl.lua"),
		[Storage.PathOfTheUndead.Questline] = loadStrings("sciezka_nieumarlych_pl.lua"),
		[Storage.ImRestingHere.Questline] = loadStrings("spoczywajacy_tutaj_pl.lua"),
		[Storage.SultanPrime.Questline] = loadStrings("sultan_prime_pl.lua"),
		[Storage.TheaterOfCheapThrills.Questline] = loadStrings("teatr_taniej_sensacji_pl.lua"),
		[Storage.FourActTragedy.Questline] = loadStrings("tragedya_w_czterech_aktach_pl.lua"),
		...
		[Storage.ProdigalSon.Questline] = loadStrings("syn_marnotrawny_pl.lua"),
	...
	["EN"] = {
		...
		[Storage.TheThreeSramatiansAndTheDragon.Questline] = loadStrings("trzej_sramaci_i_smok_en.lua"),
		[Storage.AssassinsCreedSquurvaali.Questline] = loadStrings("assassins_creed_skurwoala_en.lua"),
		[Storage.SafetyAndOccupationalHygiene.Questline] = loadStrings("bezpieczenstwo_i_higiena_pracy_en.lua"),
		[Storage.ChesterTheDwarf.Questline] = loadStrings("czeslaw_krasnolud_en.lua"),
		[Storage.DesertQuestGhosts.Questline] = loadStrings("desert_quest_ghosts_en.lua"),
		[Storage.KingOfRatsHQ.Questline] = loadStrings("krol_szczurow_hub_en.lua"),
		[Storage.PerIustitiaAdAstra.Questline] = loadStrings("per_iustitia_ad_astra_en.lua"),
		[Storage.PathOfTheUndead.Questline] = loadStrings("sciezka_nieumarlych_en.lua"),
		[Storage.ImRestingHere.Questline] = loadStrings("spoczywajacy_tutaj_en.lua"),
		[Storage.SultanPrime.Questline] = loadStrings("sultan_prime_en.lua"),
		[Storage.TheaterOfCheapThrills.Questline] = loadStrings("teatr_taniej_sensacji_en.lua"),
		[Storage.FourActTragedy.Questline] = loadStrings("tragedya_w_czterech_aktach_en.lua"),
		...
		[Storage.ProdigalSon.Questline] = loadStrings("syn_marnotrawny_en.lua"),
