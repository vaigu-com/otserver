...
monster.summon = {
	...
	summons = {
		...
		{ name = "Minotaur Guard", chance = 15, interval = 1000, count = 1 },
		{ name = "Minotaur Mage", chance = 10, interval = 1000, count = 1 },
	},
}
...
monster.loot = {
	...
	{ id = 3450, chance = 48000, maxCount = 44 }, -- power bolt
	...
	{ id = 7401, chance = 71900 }, -- minotaur trophy,
	{ id = 21174, chance = 12000 }, -- mino lance
	{ id = 21175, chance = 16000 }, -- mino shield
	{ id = 3396, chance = 25550 },
	{ id = 21166, chance = 12410 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -200, range = 7, shootEffect = CONST_ANI_BOLT, target = false },
	-- poison
	{ name = "condition", type = CONDITION_POISON, interval = 2000, chance = 40, minDamage = -10, maxDamage = -200, range = 10, shootEffect = CONST_ANI_POISON, target = false },
}

monster.defenses = {
	defense = 33,
	armor = 30,
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 80, maxDamage = 200, effect = CONST_ME_MAGIC_RED, target = false },
