...
monster.loot = {
	...
	{ name = "wood cape", chance = 2492 },
	{ name = "great health potion", chance = 16400, maxCount = 2 },
	{ name = "wooden spellbook", chance = 292 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -90, maxDamage = -200 },
