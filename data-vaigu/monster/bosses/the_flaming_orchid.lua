...
monster.loot = {
	...
	{ name = "gold ingot", chance = 19700, maxCount = 5 },
	{ name = "assassin star", chance = 29700, maxCount = 13 },
	{ name = "demonic essence", chance = 33330 },
	{ name = "great spirit potion", chance = 33330 },
	{ name = "soul orb", chance = 89530 },
	...
	{ id = 8908, chance = 11200 },
	{ id = 8899, chance = 11200 },
...
monster.defenses = {
	defense = 55,
	armor = 55,
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_HEALING, minDamage = 50, maxDamage = 280, effect = CONST_ME_MAGIC_BLUE, target = false },
	{ name = "speed", interval = 2000, chance = 25, speedChange = 320, duration = 5000, areaEffect = CONST_ME_MAGIC_RED },
	{ name = "invisible", interval = 2000, chance = 50, duration = 5000, areaEffect = CONST_ME_MAGIC_BLUE },
}
