...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -3, condition = { type = CONDITION_POISON, totalDamage = 200, interval = 4000 } },
	{ name = "brimstone bug paralyze", interval = 2000, chance = 15, range = 7, target = false },
	{ name = "condition", type = CONDITION_POISON, interval = 2000, chance = 20, minDamage = -8, maxDamage = -16, radius = 6, effect = CONST_ME_BIGPLANTS, target = false },
	{ name = "combat", interval = 2000, chance = 16, type = COMBAT_EARTHDAMAGE, minDamage = -1, maxDamage = -3, radius = 7, effect = CONST_ME_BIGPLANTS, target = false },
	{ name = "combat", interval = 2000, chance = 16, type = COMBAT_MANADRAIN, minDamage = -6, maxDamage = -8, length = 8, spread = 0, effect = CONST_ME_HITBYPOISON, target = false },
	{ name = "brimstone bug wave", interval = 2000, chance = 16, minDamage = -6, maxDamage = -10, target = false },
