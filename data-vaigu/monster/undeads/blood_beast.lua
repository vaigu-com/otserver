...
monster.loot = {
	...
	{ id = 9640, chance = 5080 }, -- poisonous slime
	{ id = 21146, chance = 2720 }, -- glooth steak
	{ id = 21194, chance = 2040 }, -- slime heart
	...
	{ id = 21158, chance = 1280 }, -- glooth spear
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 82, attack = 50, condition = { type = CONDITION_POISON, totalDamage = 260, interval = 4000 } },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -65, maxDamage = -145, range = 5, shootEffect = CONST_ANI_GREENSTAR, effect = CONST_ME_POISONAREA, target = true },
	-- poison
