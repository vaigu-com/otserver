...
monster.loot = {
	...
	{ name = "royal helmet", chance = 470 },
	{ id = 20063, chance = 850 }, -- dream matter
	{ name = "cluster of solace", chance = 960 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -698 },
	...
	{ name = "speed", interval = 2000, chance = 15, speedChange = -600, length = 8, spread = 0, effect = CONST_ME_PURPLEENERGY, target = false, duration = 4000 },
	...
	{ name = "shock head skill reducer 1", interval = 2000, chance = 8, range = 5, target = false },
	{ name = "shock head skill reducer 2", interval = 2000, chance = 7, target = false },
}
