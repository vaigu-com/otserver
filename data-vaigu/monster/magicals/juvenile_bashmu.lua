...
monster.loot = {
	...
	{ name = "great spirit potion", chance = 14700, maxCount = 3 },
	{ name = "ultimate health potion", chance = 1300, maxCount = 4 },
	{ name = "blue crystal shard", chance = 6160, maxCount = 2 },
	{ name = "bashmu tongue", chance = 5840, maxCount = 2 },
	...
	{ name = "violet gem", chance = 1340, maxCount = 1 },
	{ name = "lightning legs", chance = 1230 },
	{ name = "diamond sceptre", chance = 1180 },
	{ name = "lightning pendant", chance = 1180 },
	{ name = "bashmu fang", chance = 2120 },
	{ name = "yellow gem", chance = 2070 },
	{ name = "war hammer", chance = 2540 },
	{ name = "violet crystal shard", chance = 2490 },
	{ name = "dragonbone staff", chance = 1030 },
	{ name = "amber staff", chance = 1070 },
	{ name = "lightning boots", chance = 1270 },
	{ name = "green gem", chance = 1220 },
	{ name = "spellweaver's robe", chance = 1010 },
	{ name = "pair of iron fists", chance = 1010 },
	{ name = "skull staff", chance = 760 },
	{ name = "crystal mace", chance = 700 },
