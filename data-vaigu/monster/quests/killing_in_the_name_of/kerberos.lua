...
monster.loot = {
	...
	{ id = 6499, chance = 72500 }, -- demonic essence
	...
	{ id = 238, chance = 96880, maxCount = 10 }, -- great mana potion
	{ id = 7453, chance = 3130 }, -- executioner
	{ id = 3360, chance = 31250 }, -- golden armor
	{ id = 25759, chance = 71250, maxCount = 15 },
	{ id = 9301, chance = 31250 },
	
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -508 },
	{ name = "combat", interval = 2000, chance = 5, type = COMBAT_EARTHDAMAGE, minDamage = 0, maxDamage = -700, length = 6, spread = 3, effect = CONST_ME_CARNIPHILA, target = false },
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = 0, maxDamage = -662, length = 5, spread = 4, effect = CONST_ME_FIREAREA, target = false },
