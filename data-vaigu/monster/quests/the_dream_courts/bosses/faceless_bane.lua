...
mType.onSpawn = function(monster, spawnPosition)
	if monster:getType():isRewardBoss() then
		...
		Game.setStorageValueByKey(GlobalStorage.TheDreamCourts.FacelessBane.Deaths, -1)
		Game.setStorageValueByKey(GlobalStorage.TheDreamCourts.FacelessBane.StepsOn, -1)
		Game.setStorageValueByKey(GlobalStorage.TheDreamCourts.FacelessBane.ResetSteps, 1)
