...
monster.loot = {
	{ id = 24941, chance = 90000 }, -- horn of kalyassa
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -210, maxDamage = -535, length = 9, spread = 4, effect = CONST_ME_FIREAREA, target = false },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -330, maxDamage = -795, length = 8, spread = 2, effect = CONST_ME_FIREAREA, target = false },
