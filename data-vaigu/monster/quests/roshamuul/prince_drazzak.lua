...
monster.loot = {
	...
	{ id = 20062, chance = 100000, maxCount = 5 }, -- cluster of solace
	...
	{ id = 20277, chance = 45000 }, -- psychedelic tapestry
	{ id = 20278, chance = 45000 }, -- demonic tapestry
	{ id = 5741, chance = 12500 }, -- skull helmet
	...
	{ id = 21955, chance = 15000 },
	{ id = 3402, chance = 8000 },
	{ id = 3564, chance = 17000 },
	{ id = 20089, chance = 2000 },
	{ id = 20083, chance = 2000 },
	{ id = 20065, chance = 2000 },
	{ id = 20071, chance = 2000 },
	{ id = 20077, chance = 2000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 190, attack = 100 },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -1300, maxDamage = -2600, range = 4, radius = 5, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "diabolic imp skill reducer", interval = 2000, chance = 10, range = 7, target = false },
	{ name = "combat", interval = 2000, chance = 18, type = COMBAT_DEATHDAMAGE, minDamage = -1000, maxDamage = -2500, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false },
}
...
monster.defenses = {
	...
	armor = 55,
	--	mitigation = ???,
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 2000, effect = CONST_ME_MAGIC_RED, target = false },
}
