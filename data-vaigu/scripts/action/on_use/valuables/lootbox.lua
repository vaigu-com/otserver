...
local realLootboxData = {
	LootboxData({
		...
		rewards = {
			LootboxReward({ rewardItemId = 14084, weight = 591, count = 5 }),
			LootboxReward({ rewardItemId = 3031, weight = 557, count = 6 }),
			LootboxReward({ rewardItemId = 3723, weight = 506, count = 1 }),
			LootboxReward({ rewardItemId = 5890, weight = 488, count = 1 }),
			LootboxReward({ rewardItemId = 3492, weight = 470, count = 4 }),
			LootboxReward({ rewardItemId = 3606, weight = 468, count = 1 }),
			LootboxReward({ rewardItemId = 5899, weight = 424, count = 1 }),
			LootboxReward({ rewardItemId = 5894, weight = 401, count = 1 }),
			LootboxReward({ rewardItemId = 9689, weight = 373, count = 1 }),
			LootboxReward({ rewardItemId = 3291, weight = 366, count = 1 }),
			LootboxReward({ rewardItemId = 8031, weight = 358, count = 1 }),
			LootboxReward({ rewardItemId = 5902, weight = 299, count = 1 }),
			LootboxReward({ rewardItemId = NO_REWARD, weight = 215, count = 1 }),
			LootboxReward({ rewardItemId = 3572, weight = 141, count = 1 }),
			LootboxReward({ rewardItemId = 3083, weight = 100, count = 1 }),
			LootboxReward({ rewardItemId = 12787, weight = 87, count = 1 }),
			...
			LootboxReward({ rewardItemId = 2991, weight = 46, count = 1 }),
			...
			LootboxReward({ rewardItemId = 3079, weight = 3, count = 1 }),
		},
	...
	LootboxData({
		...
		rewards = {
			...
			LootboxReward({ rewardItemId = 239, weight = 1953, count = 2 }),
			LootboxReward({ rewardItemId = 238, weight = 1674, count = 2 }),
	...
	LootboxData({
		...
		rewards = {
			LootboxReward({ rewardItemId = 22187, weight = 1440, count = 5 }),
			LootboxReward({ rewardItemId = 22191, weight = 994, count = 1 }),
			LootboxReward({ rewardItemId = 22184, weight = 836, count = 1 }),
			LootboxReward({ rewardItemId = 22194, weight = 815, count = 2 }),
			LootboxReward({ rewardItemId = 22188, weight = 751, count = 1 }),
			LootboxReward({ rewardItemId = 22193, weight = 611, count = 3 }),
			LootboxReward({ rewardItemId = 3403, weight = 600, count = 1 }),
			LootboxReward({ rewardItemId = 3406, weight = 529, count = 1 }),
			LootboxReward({ rewardItemId = 7432, weight = 518, count = 1 }),
			...
			LootboxReward({ rewardItemId = 3560, weight = 323, count = 1 }),
	...
	LootboxData({
		...
		rewards = {
			LootboxReward({ rewardItemId = 3723, weight = 1440, count = 10 }),
			LootboxReward({ rewardItemId = 2995, weight = 994, count = 1 }),
			LootboxReward({ rewardItemId = 3572, weight = 836, count = 1 }),
			LootboxReward({ rewardItemId = 5880, weight = 815, count = 1 }),
			LootboxReward({ rewardItemId = 3044, weight = 751, count = 1 }),
			LootboxReward({ rewardItemId = 3083, weight = 611, count = 1 }),
			LootboxReward({ rewardItemId = 5879, weight = 600, count = 1 }),
			LootboxReward({ rewardItemId = 6570, weight = 529, count = 1 }),
			LootboxReward({ rewardItemId = 3049, weight = 518, count = 1 }),
			LootboxReward({ rewardItemId = 5882, weight = 465, count = 1 }),
			LootboxReward({ rewardItemId = 12548, weight = 404, count = 1 }),
			LootboxReward({ rewardItemId = 15698, weight = 354, count = 1 }),
			LootboxReward({ rewardItemId = 3046, weight = 311, count = 1 }),
			LootboxReward({ rewardItemId = 22194, weight = 304, count = 1 }),
			LootboxReward({ rewardItemId = 8899, weight = 300, count = 1 }),
			...
			LootboxReward({ rewardItemId = 9058, weight = 57, count = 1 }),
			LootboxReward({ rewardItemId = 22737, weight = 36, count = 1 }),
			LootboxReward({ rewardItemId = 23536, weight = 29, count = 1 }),
			LootboxReward({ rewardItemId = 22731, weight = 43, count = 1 }),
		},
		effect = CONST_ME_CRAPS,
	}),
	LootboxData({
	...
	LootboxData({
		...
		rewards = {
			LootboxReward({ rewardItemId = 236, weight = 5000, count = 1 }),
	...
	LootboxData({
		...
		rewards = {
			LootboxReward({ rewardItemId = 21158, weight = 1875, count = 2 }),
			...
			LootboxReward({ rewardItemId = 21295, weight = 634, count = 1 }),
			LootboxReward({ rewardItemId = 21143, weight = 514, count = 10 }),
			LootboxReward({ rewardItemId = 21144, weight = 495, count = 10 }),
			LootboxReward({ rewardItemId = 21146, weight = 454, count = 10 }),
	...
	LootboxData({
		...
		rewards = {
			...
			LootboxReward({ rewardItemId = 7443, weight = 700, count = 1 }),
			LootboxReward({ rewardItemId = 7439, weight = 300, count = 1 }),
			...
			LootboxReward({ rewardItemId = 16165, weight = 200, count = 1 }),
	...
	LootboxData({
		...
		rewards = {
			LootboxReward({ rewardItemId = 3108, weight = 1081, count = 1 }),
			LootboxReward({ rewardItemId = 2992, weight = 1044, count = 1 }),
			LootboxReward({ rewardItemId = 5792, weight = 984, count = 1 }),
			LootboxReward({ rewardItemId = 906, weight = 965, count = 1 }),
			LootboxReward({ rewardItemId = 3659, weight = 965, count = 1 }),
			LootboxReward({ rewardItemId = 3568, weight = 968, count = 1 }),
			LootboxReward({ rewardItemId = 3463, weight = 962, count = 1 }),
			LootboxReward({ rewardItemId = 2995, weight = 488, count = 1 }),
			LootboxReward({ rewardItemId = 2950, weight = 488, count = 1 }),
			LootboxReward({ rewardItemId = 651, weight = 323, count = 1 }),
			LootboxReward({ rewardItemId = 5929, weight = 391, count = 1 }),
			LootboxReward({ rewardItemId = 3577, weight = 325, count = 1 }),
			...
			LootboxReward({ rewardItemId = 3004, weight = 61, count = 1 }),
			...
			LootboxReward({ rewardItemId = 12548, weight = 14, count = 1 }),
		},
...
function lootboxUse.onUse(player, lootbox, fromPosition, target, toPosition, isHotkey)
	...
	if reward then
		player:addItem(reward.rewardItemId, reward.count)
	else
