...
local movementOut = MoveEvent()

function movementOut.onStepOut(creature, item, toPosition, fromPosition)
	cracklerTransform = false
	return true
end

movementOut:type("stepout")
movementOut:id(23471)
movementOut:register()
