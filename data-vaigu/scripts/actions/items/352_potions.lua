...
local potions = {
	...
	[237] = { mana = { 115, 185 }, level = 50, flask = 283, access = Storage.EnterTheDrunkTankChamberlain.MediumManaPotion, description = "Only players of level 50 or above may drink this fluid." },
	[238] = { mana = { 150, 250 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID }, level = 80, flask = 284, access = Storage.EnterTheDrunkTankChamberlain.GreatManaPotion, description = "Only druids, sorcerers and paladins of level 80 or above may drink this fluid." },
	[23373] = { mana = { 425, 575 }, vocations = {}, level = 180, flask = 284, access = Storage.EnterTheDrunkTankChamberlain.UltimateManaPotion, description = "Only druids and sorcerers of level 180 or above may drink this fluid." },
