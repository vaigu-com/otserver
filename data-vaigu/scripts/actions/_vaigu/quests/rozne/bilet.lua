...
function action.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item_id == item.itemid and player:getStorageValue(Storage.OcellatusXD.Mission01) == 1 and item.uid == 11041 then
		player:setStorageValue(Storage.OcellatusXD.Mission01, 2)
