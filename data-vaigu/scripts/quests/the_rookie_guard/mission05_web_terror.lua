...
function missionGuide.onStepIn(creature, item, position, fromPosition)
	...
	local state = player:getStorageValueByKey(Storage.Quest.U9_1.TheRookieGuard.Mission05)
...
function spiderLairHole.onStepIn(creature, item, position, fromPosition)
	...
	local missionState = player:getStorageValueByKey(Storage.Quest.U9_1.TheRookieGuard.Mission05)
...
function greasyStone.onUse(player, item, frompos, item2, topos)
	...
	if missionState <= 2 or missionState == 4 then
		...
		player:setStorageValueByKey(Storage.Quest.U9_1.TheRookieGuard.Mission05, 2)
	else
...
function spiderWeb.onUse(player, item, frompos, item2, topos)
	...
	if missionState == 2 or missionState == 4 then
		...
		player:setStorageValueByKey(Storage.Quest.U9_1.TheRookieGuard.Mission05, 3)
	end
	return true
end
