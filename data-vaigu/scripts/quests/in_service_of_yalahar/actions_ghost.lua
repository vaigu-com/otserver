...
function inServiceYalaharGhost.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if target.itemid == 8859 then
		player:setStorageValueByKey(Storage.Quest.U8_4.InServiceOfYalahar.Questline, 37)
		player:setStorageValueByKey(Storage.Quest.U8_4.InServiceOfYalahar.Mission06, 3) -- StorageValue for Questlog "Mission 06: Frightening Fuel"
