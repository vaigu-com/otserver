...
local function doClearAreaAzerus()
	if Game.getStorageValueByKey(Storage.Quest.U8_4.InServiceOfYalahar.LastFight) == 1 then
		...
		Game.setStorageValueByKey(Storage.Quest.U8_4.InServiceOfYalahar.LastFight, 0)
	end
	return true
end
...
function inServiceYalaharLastFight.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	Game.setStorageValueByKey(Storage.Quest.U8_4.InServiceOfYalahar.LastFight, 1)
