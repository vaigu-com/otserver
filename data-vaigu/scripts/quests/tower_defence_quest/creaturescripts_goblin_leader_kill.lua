...
function creaturescripts_goblin_leader_kill.onDeath(creature)
	onDeathForDamagingPlayers(creature, function(creature, player)
		if player:getStorageValueByKey(Storage.Quest.U8_1.TowerDefenceQuest.Questline) == 2 then
			player:setStorageValueByKey(Storage.Quest.U8_1.TowerDefenceQuest.Questline, 3)
		end
	end)
