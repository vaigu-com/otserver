...
TEATR_TANIEJ_SENSACJI_PLUS_SHAPE = {
	...
	aidToMachineConfig = {
		[Storage.TeatrTaniejSensacji.PlusShapePuzzle.MachineNorth] = {
		...
		[Storage.TeatrTaniejSensacji.PlusShapePuzzle.MachineCenter] = {
		...
		[Storage.TeatrTaniejSensacji.PlusShapePuzzle.MachineWest] = {
