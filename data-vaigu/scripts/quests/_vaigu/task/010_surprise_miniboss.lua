...
local surpriseMinibossesDatas = {
	SurpriseMiniboss({ regularMonsters = { "Lizard Chosen" }, minibosses = { "The Voice of Ruin" }, chance = 0.009 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Lizard Dragon Priest" }, minibosses = { "Flamecaller Zazrak" }, chance = 0.009 }),
	SurpriseMiniboss({ regularMonsters = { "Lich" }, minibosses = { "Gravelord Oshuran" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Lizard High Guard" }, minibosses = { "Lizard Gate Guardian" }, chance = 0.009 }),
	SurpriseMiniboss({ regularMonsters = { "Dragon" }, minibosses = { "Grand Mother Foulscale" }, chance = 0.007 }),
	SurpriseMiniboss({ regularMonsters = { "Faun", "Dark Faun" }, minibosses = { "Raxias" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Cyclops Smith" }, minibosses = { "The Old Whopper" }, chance = 0.009 }),
	SurpriseMiniboss({ regularMonsters = { "Kongra" }, minibosses = { "Golira" }, chance = 0.007 }),
	SurpriseMiniboss({ regularMonsters = { "Terramite" }, minibosses = { "Thermite" }, chance = 0.006 }),
	SurpriseMiniboss({ regularMonsters = { "Crocodile" }, minibosses = { "The Snapper" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Mutated Tiger" }, minibosses = { "Tigre" }, chance = 0.005 }),
	SurpriseMiniboss({ regularMonsters = { "Ogre Savage" }, minibosses = { "Brutus" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Valkyrie" }, minibosses = { "Xenia" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Metal Gargoyle" }, minibosses = { "Titan Gargoyle" }, chance = 0.006 }),
	SurpriseMiniboss({ regularMonsters = { "Thornback Tortoise" }, minibosses = { "Thorner" }, chance = 0.008 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Carrion Worm" }, minibosses = { "White Pale" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Witch" }, minibosses = { "Yaga the Crone", "Ekatrix" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Lion" }, minibosses = { "Zomba" }, chance = 0.05 }),
	SurpriseMiniboss({ regularMonsters = { "Wasp" }, minibosses = { "Willi Wasp" }, chance = 0.02 }),
	SurpriseMiniboss({ regularMonsters = { "Wereboar" }, minibosses = { "Owin" }, chance = 0.004 }),
	SurpriseMiniboss({ regularMonsters = { "Sandstone Scorpion" }, minibosses = { "Utua Stone Sting" }, chance = 0.007 }),
	SurpriseMiniboss({ regularMonsters = { "Stampor" }, minibosses = { "Tromphonyte" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Wailing Widow" }, minibosses = { "Fiery Widow" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Serpent Spawn" }, minibosses = { "Srezz Yellow Eyes" }, chance = 0.004 }),
	SurpriseMiniboss({ regularMonsters = { "Werewolf" }, minibosses = { "Darkfang" }, chance = 0.005 }),
	SurpriseMiniboss({ regularMonsters = { "Werebadger" }, minibosses = { "Sharpclaw" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Werehyaena", "Werehyaena Shaman" }, minibosses = { "Katex Blood Tongue" }, chance = 0.006 }),
	SurpriseMiniboss({ regularMonsters = { "Quara Predator", "Quara Hydromancer" }, minibosses = { "Thul" }, chance = 0.007 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Medusa" }, minibosses = { "Gorgo" }, chance = 0.004 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Spitter" }, minibosses = { "Rotspit" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Waspoid" }, minibosses = { "Chopper" }, chance = 0.005 }),
	SurpriseMiniboss({ regularMonsters = { "Insectoid Worker" }, minibosses = { "Mindmasher" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Giant Spider" }, minibosses = { "Mamma Longlegs" }, chance = 0.007 }),
	SurpriseMiniboss({ regularMonsters = { "Bog Raider" }, minibosses = { "Weakened Shlorg" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Enlightened of the Cult" }, minibosses = { "Grandfather Tridian" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Brimstone Bug" }, minibosses = { "Sulphur Scuttler" }, chance = 0.006 }),
	SurpriseMiniboss({ regularMonsters = { "Crystal Spider" }, minibosses = { "The Bloodweb" }, chance = 0.004 }),
	SurpriseMiniboss({ regularMonsters = { "Destroyer" }, minibosses = { "Bretzecutioner" }, chance = 0.006 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Mutated Bat" }, minibosses = { "Bruise Payne" }, chance = 0.005 }),
	SurpriseMiniboss({ regularMonsters = { "Vampire Bride", "Vampire Viscount" }, minibosses = { "Boreth" }, chance = 0.004 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Putrid Mummy" }, minibosses = { "Thalas", "Omruc", "Mahrdis", "Morguthis", "Vashresamun" }, chance = 0.003 }),
	SurpriseMiniboss({ regularMonsters = { "Guzzlemaw" }, minibosses = { "Mawhawk" }, chance = 0.004 }),
	SurpriseMiniboss({ regularMonsters = { "Lancer Beetle" }, minibosses = { "The Blightfather" }, chance = 0.004 }),
	SurpriseMiniboss({ regularMonsters = { "Elf Arcanist" }, minibosses = { "Dharalion" }, chance = 0.004 }),
	SurpriseMiniboss({ regularMonsters = { "Hellhound" }, minibosses = { "Mozradek" }, chance = 0.007 }),
	SurpriseMiniboss({ regularMonsters = { "Adult Goanna" }, minibosses = { "Yirkas Blue Scales" }, chance = 0.009 }),
	SurpriseMiniboss({ regularMonsters = { "Dwarf Guard" }, minibosses = { "Foreman Kneebiter" }, chance = 0.007 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Werefox" }, minibosses = { "Black Vixen" }, chance = 0.006 }),
	SurpriseMiniboss({ regularMonsters = { "Hydra" }, minibosses = { "Tazhadur" }, chance = 0.003 }),
	SurpriseMiniboss({ regularMonsters = { "Skeleton", "Ghoul", "Pirate Skeleton", "Mummy", "Crypt Shambler" }, minibosses = { "Undead Jester" }, chance = 0.003 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Burster Spectre", "Gazer Spectre", "Ripper Spectre" }, minibosses = { "Faceless Bane" }, chance = 0.002 }),
