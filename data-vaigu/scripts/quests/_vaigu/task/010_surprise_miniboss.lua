...
local surpriseMinibossesDatas = {
	...
	SurpriseMiniboss({ regularMonsters = { "Lich" }, minibosses = { "Gravelord Oshuran" }, chance = 0.009 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Serpent Spawn" }, minibosses = { "Srezz Yellow Eyes" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Werewolf" }, minibosses = { "Darkfang" }, chance = 0.008 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Medusa" }, minibosses = { "Gorgo" }, chance = 0.007 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Bog Raider" }, minibosses = { "Weakened Shlorg" }, chance = 0.009 }),
	SurpriseMiniboss({ regularMonsters = { "Enlightened of the Cult" }, minibosses = { "Grandfather Tridian" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Brimstone Bug" }, minibosses = { "Sulphur Scuttler" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Crystal Spider" }, minibosses = { "The Bloodweb" }, chance = 0.008 }),
	SurpriseMiniboss({ regularMonsters = { "Destroyer" }, minibosses = { "Bretzecutioner" }, chance = 0.008 }),
	...
	SurpriseMiniboss({ regularMonsters = { "Burster Spectre", "Gazer Spectre", "Ripper Spectre" }, minibosses = { "Faceless Bane" }, chance = 0.003 }),
