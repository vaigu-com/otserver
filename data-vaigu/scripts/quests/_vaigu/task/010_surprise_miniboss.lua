...
local surpriseMinibossesDatas = {
	...
	SurpriseMinibossData({ regularMonsters = { "Ice Witch" }, minibosses = { "Yakchal" }, chance = 0.01 }),
	...
	SurpriseMinibossData({ regularMonsters = { "Dragon" }, minibosses = { "Grand Mother Foulscale" }, chance = 0.01 }),
	...
	SurpriseMinibossData({ regularMonsters = { "Orc Marauder" }, minibosses = { "Cublarc the Plunderer" }, chance = 0.02 }),
	...
	SurpriseMinibossData({ regularMonsters = { "Medusa" }, minibosses = { "Gorga" }, chance = 0.01 }),
	...
	SurpriseMinibossData({ regularMonsters = { "Giant Spider" }, minibosses = { "Mamma Longlegs" }, chance = 0.02 }),
	SurpriseMinibossData({ regularMonsters = { "Bog Raider" }, minibosses = { "Weakened Shlorg" }, chance = 0.01 }),
	SurpriseMinibossData({ regularMonsters = { "Brimstone Bug" }, minibosses = { "Sulphur Scuttler" }, chance = 0.02 }),
	SurpriseMinibossData({ regularMonsters = { "Crystal Spider" }, minibosses = { "The Bloodweb" }, chance = 0.03 }),
