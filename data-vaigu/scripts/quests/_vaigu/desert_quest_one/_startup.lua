...
local startupItems = {
	...
	normalSings = {
		{ pos = { 69, 81, 0 }, id = 2023, aid = Storage.DesertQuestOne.Readable.ShortcutSign, desc = "SHORTCUT_SIGN" },
		{ pos = { 2, 45, 2 }, id = 2024, aid = Storage.DesertQuestOne.Readable.ShortcutSign, desc = "SHORTCUT_SIGN" },
		{ pos = { 14, 155, 2 }, id = 2024, aid = Storage.DesertQuestOne.Readable.ShortcutSign, desc = "SHORTCUT_SIGN" },
		{ pos = { 13, -2, 1 }, id = 2024, aid = Storage.DesertQuestOne.Readable.ShortcutSign, desc = "SHORTCUT_SIGN" },
		{ pos = { 6, -36, -2 }, id = 2023, aid = Storage.DesertQuestOne.Readable.ShortcutSign, desc = "SHORTCUT_SIGN" },
		{ pos = { -14, 67, 2 }, id = 2023, aid = Storage.DesertQuestOne.Readable.ShortcutSign, desc = "SHORTCUT_SIGN" },
		{ pos = { -38, 96, 2 }, id = 2023, aid = Storage.DesertQuestOne.Readable.ShortcutSign, desc = "SHORTCUT_SIGN" },
		{ pos = { -60, 140, 2 }, id = 2024, aid = Storage.DesertQuestOne.Readable.ShortcutSign, desc = "SHORTCUT_SIGN" },

		{ pos = { 18, 161, 1 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { -17, 65, 0 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { 72, 106, 1 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { -24, 108, 2 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { -45, -7, 1 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { 11, -35, -2 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { -12, -5, 1 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { -106, 168, 2 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { -9, 44, 2 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { -22, 72, 2 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
		{ pos = { -47, 141, 2 }, id = 2014, aid = Storage.DesertQuestOne.Readable.ToStartSign, desc = "TO_START_SIGN" },
	},
	vocTiles = {
