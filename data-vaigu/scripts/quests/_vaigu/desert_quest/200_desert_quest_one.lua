		...
		return ANY_STATE,
			...
			QuestFactory.Script(function(missionState)
				local vectorToMessage = {
					...
					[Vector(-53, -33, 1)] = "I noticed that this room is split into two floors. There are signs on upper and lower floor. On upper floor there are seven signs with colored floor. If you follow its direction you will arrive at another sign. Follow it, and reapeat until you end up at another sign with colored ground. This can be done if you start at any colored sign, but one, meaning there is no sign that points to this colored one. That one has *UNINTELLIGIBLE* color. You should enter portal with more or less the same colour as this one.\n\n~Pages 85, 86 of Eustachy Wiertara journal.",
