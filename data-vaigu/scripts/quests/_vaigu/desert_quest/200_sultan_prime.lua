...
quest
	...
	:Constant(function()
		QuestKeyItems.SultanPrime = {
			Bottle = { id = 10183, key = Storage.SultanPrime.MagicianBottle },
			...
			missions = {
				...
				},
				{
					...
					states = {
						...
						[QuestState.SultanPrime.Mission03.GetRidOfAspirantRyba] = "~Sultan69: It's time to get rid of Deputy Fisher. After work, you can leave the barracks through the northern doors and use the shortcut.",
						[QuestState.SultanPrime.Mission03.ReportToSultan] = "~Sultan69: How did Fisher escape? The Crypt King also fell in battle. Come back immediately so I can chew you out!",
						...
						[MISSION_FINISHED] = "Father Natanek gave you today's offering from today's Mass in exchange for your silence.",
					},
				},
			},
		})
	...
	:MonsterEvent(function()
		...
		function cezary.onDeath(creature)
			...
			corpse:setKey(Storage.SultanPrime.Necklace)
	...
	:State(function()
		return MISSION_NOT_STARTED, QuestFactory.OnUseDeclarations({
	...
	:State(function()
		return QuestState.SultanPrime.Mission01.ConsultSultanAboutAmulet,
			QuestFactory.Dialog("Sultan of Phantasms", {
				[{ GREET }] = {
					text = "Adventurer |PLAYERNAME|... I was watching you proceed through that dungeon and beat all the deadly traps. You might have something that I value. Precisely that {amulet} that you took from Cezary Baryka.",
					nextState = {
		...
		return QuestState.SultanPrime.Mission01.TradeAmuletWithSultan,
			QuestFactory.Dialog("Sultan of Phantasms", {
				...
				[{ "mission", "amulet", "naszyjnik" }] = {
					...
					textNoRequiredItems = "Ehh, you lost it? Guess I'mma take over the world in next season.",
					nextState = {
						[Storage.SultanPrime.Mission01] = MISSION_FINISHED,
		...
		return QuestState.SultanPrime.Mission02.PoisonMagiciansWell,
			...
			QuestFactory.Script(function(missionState)
				...
				function taintBottle.onUse(player, bottle, fromPosition, target, toPosition, isHotkey)
					...
					if target:getKey() ~= Storage.SultanPrime.MagicianFountain then
						return false
					end
				...
				taintBottle:key(Storage.SultanPrime.MagicianBottle)
	...
	:State(function()
		return QuestState.SultanPrime.Mission02.AskSultanForCamelTask,
			QuestFactory.Dialog("Sultan of Phantasms", {
				[{ GREET }] = {
					text = "Hi, |PLAYERNAME|. Did you manage to complete your first task?",
				},
				[{ "mission", "yes", "tak" }] = {
					text = "Good job. Now we will take care of a certain farmer from the steppes. Dampreefer is a hermit. I offered for him to join me, but he refused. Go to his farm and cull his farm animals. This should make him sign himself on a suicide wishlist, heh. Dampreefer is very poor, so you might need to help him with that. Maybe Leroy Merlin rope $6.99/meter?",
					nextState = {
		...
		return QuestState.SultanPrime.Mission02.ProvideDampreeferWithRope,
			...
			QuestFactory.Script(function(missionState)
				...
				function chair.onAddItem(maybeRope, tileitem, position)
					...
					local players = CreatureList():RadiusSquare(position, 5, 5):FilterByPlayer():Get()
					...
					Game.createItem(18114, 1, position):decay()
					return true
				end
				chair:type("additem")
		...
		return QuestState.SultanPrime.Mission03.ThrowBodies,
			...
			QuestFactory.Script(function(missionState)
				...
				function eatingJaw.onAddItem(corpse, tile, position)
					...
					tentacleMonster = tentacleMonster or Tile(tentaclyJawPos):getTopCreature()
		...
		return QuestState.SultanPrime.Mission03.AskNatanekForHelp,
			QuestFactory.Dialog("Father Natanek", {
				[{ "mission", "misja", "naszyjnik", "amulet", "necklace" }] = {
					text = "I'd prefer this information to stay between us. Let's agree that you'll take what I {received} from our city faithful today. In exchange, you'll forget what Sultan showed you.",
				},
				[{ "zebralem", "received" }] = {
					text = "Here, this is your reward.",
					nextState = {
						[Storage.SultanPrime.Mission03] = MISSION_FINISHED,
