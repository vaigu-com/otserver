...
quest
			...
			missions = {
				...
				[Storage.LocalSupport.SettledDownFishmonger] = {
					...
					states = {
						...
						[2] = "Anon's father needs help finding some old junk he carried with him for fishing. Search all boats, piers, and swamps around Mirko Town for any found items.",
						[3] = "Anon's father received his table in a deplorable state, ask how you can improve his mood.",
						[4] = "You helped Anon's father with all the troubles. Now, go to his son for your reward.",
						[5] = "You have received a reward from the Fisherman Son. You gained the ability to purchase Shimmer Swimmer.",
					},
				},
			},
		}
	...
	:State(
		QuestState.LocalSupport.Discernment.VisitDealers,
	...
	:State(
		QuestState.LocalSupport.WoodDelivery.TalkWithWoody,
		QuestFactory.Dialog(
			"Woody",
	...
	:State(
		QuestState.LocalSupport.WoodDelivery.InvestigateCamp,
	...
	:State(
		QuestState.LocalSupport.WoodDelivery.DealWithNarroMafia,
		QuestFactory.Dialog("Narro", {
			[{ "drewno", "dostawa", "misja", "mission", "wood" }] = {
	...
	:State(
		QuestState.LocalSupport.WoodDelivery.TakeTrollskyReward,
		QuestFactory.Dialog("Trollsky", {
	...
	:State(
		QuestState.LocalSupport.WoodDelivery.TakeFstabReward,
		QuestFactory.Dialog("Fstab", {
			[{ "nagroda", "reward" }] = {
	...
	:State(
		...
		QuestFactory.Dialog("Walmart007", {
			[{ "help", "pomoc", "mission", "misja" }] = {
				text = "No need, but if you know some way to get rid of {rats} once and for all, tell me.",
				requiredState = {
					[Storage.LocalSupport.WalmartAsked] = MISSION_FINISHED,
				},
			},
	...
	:State(
		QuestState.LocalSupport.FreakingRats.AskGertrudeForRepellant,
	...
	:State(
		QuestState.LocalSupport.FreakingRats.BringMouldyCheeseToGertrude,
		QuestFactory.Dialog("Gertrude", {
			[{ "szczur", "szczury", "trutka", "ser", "rat", "rats" }] = {
	...
	:State(
		QuestState.LocalSupport.FreakingRats.BringPoisonedChesseToWalmart,
		QuestFactory.Dialog("Walmart007", {
			[{
				"mission",
				"misja",
	...
	:State(
		QuestState.LocalSupport.BudgetRecycling.BringPieceOfEachClothToMadame,
		QuestFactory.Dialog("Madame Malkin", {
			[{ "mission", "misja", "tkaninie", "cloth", "tailor" }] = {
	...
	:State(
		QuestState.LocalSupport.LostCrystalBall.FindBallForGypsy,
		QuestFactory.Dialog("Gypsy", {
			[{ "kula", "ball", "kule" }] = {
	...
	:State(
		...
		QuestFactory.Dialog("Old Postman", {
			[{ "szlakiem", "pass", "route", "mision", "misja" }] = {
				...
				requiredState = {
					[Storage.LocalSupport.PostmanAsked] = MISSION_FINISHED,
				},
			},
		})
	)
	:State(
		QuestState.LocalSupport.Biodegradable.FindPostmanPackage,
	...
	:State(
		QuestState.LocalSupport.Biodegradable.ReturnPackageToPostman,
		QuestFactory.Dialog("Old Postman", {
	...
	:State(
		QuestState.LocalSupport.Biodegradable.AskForNewMission,
		QuestFactory.Dialog("Old Postman", {
			[{ "mission", "misja" }] = {
	...
	:State(
		QuestState.LocalSupport.UnwantedGuests.BringOldManFrostItems,
		QuestFactory.Dialog("Old Man Frost", {
			[{ "mission", "misja" }] = {
	...
	:State(
		...
		QuestFactory.Dialog("Fisherman Son", {
			...
			[{ "marlin", "ryba", "rybka", "fish", "merlin" }] = {
				...
				nextState = {
					[Storage.TwoMarlinQuest] = MISSION_FINISHED,
				},
				rewards = {
					{ id = 902 },
				},
	...
	:State(
		QuestState.LocalSupport.OcellatusXD.FindTicket,
	...
	:State(
		QuestState.LocalSupport.OcellatusXD.AskOcellatusForNewMission,
		QuestFactory.Dialog("Ocellatus", {
			[{ "mission", "misja" }] = {
	...
	:State(
		QuestState.LocalSupport.OcellatusXD.BringFoodToOcellatus,
		QuestFactory.Dialog("Ocellatus", {
			[{ "mission", "misja", "food", "soup", "order", "zupa" }] = {
				...
				nextState = {
					[Storage.OcellatusXD] = MISSION_STARTED,
					[Storage.Finished.Ocellatus] = MISSION_STARTED,
				},
			},
		})
	)
	...
	:State(
		QuestState.LocalSupport.IKEAForTheBold.AskGypsy,
	...
	:State(
		QuestState.LocalSupport.IKEAForTheBold.SearchDominoUndergroundHideout,
		QuestFactory.StartupItems({
			{
				id = 2471,
				pos = { 5840, 1588, 11 },
	...
	:State(
		QuestState.LocalSupport.IKEAForTheBold.ConsultCommissioner,
		QuestFactory.Dialog("Komor", {
			[{ "all", "wszystko" }] = {
	...
	:State(
		QuestState.LocalSupport.IKEAForTheBold.AskNearbyPeople_FindMoustachilles,
	...
	:State(
		QuestState.LocalSupport.IKEAForTheBold.AskMoustachillesAboutDomino,
		QuestFactory.Dialog("Moustachilles", {
	...
	:State(
		QuestState.LocalSupport.IKEAForTheBold.FindAndKillDominoShore,
		QuestFactory.Script(function(missionState)
	...
	:State(
		QuestState.LocalSupport.IKEAForTheBold.SearchDominoShoreHideout,
		QuestFactory.StartupItems({
			{
				id = 2472,
				pos = { 6206, 1208, 7 },
	...
	:State(
		QuestState.LocalSupport.IKEAForTheBold.ReportToCommissioner,
		QuestFactory.Dialog("Commissioner Fisher", {
			[{ "mission", "misja" }] = {
	...
	:State(
		QuestState.LocalSupport.SettledDownFishmonger.DeliverAnonFatherPackage,
	...
	:State(
		QuestState.LocalSupport.SettledDownFishmonger.FindAndDevilerAnonFatherMissingItems,
		QuestFactory.Dialog("Anon's Father", {
			[{ "problem" }] = {
	...
	:State(
		QuestState.LocalSupport.SettledDownFishmonger.BringSoupToAnonFather,
		QuestFactory.Dialog("Anon's Father", {
	...
	:State(
		QuestState.LocalSupport.SettledDownFishmonger.AskFishermanSonForReward,
