...
quest
		...
		table.insert(Quests, {
			...
			missions = {
				...
				},
				{
					...
					storage = Storage.SilenceOfTheLambs.FashionistaClothes,
					states = {
						[QuestState.SilenceOfTheLambs.FashionistaClothes.BringLeatherToLecter] = "Lecter asked you to bring him 20 leathers of every kind.",
						[QuestState.SilenceOfTheLambs.FashionistaClothes.AskLecterForNewMission] = "Ask Lecter for a new mission.",
				...
				},
				{
					...
					states = {
						[QuestState.SilenceOfTheLambs.RubMeatWithLecter.BringHeartsToLecter] = "LECTER_WANTS_HEARTS_AND_LIVERS_STATUS", --3af remove livers
			...
			QuestFactory.Dialog("Lecter", {
				[{ "mission", "misja" }] = {
					...
					nextState = {
						...
						[Storage.SilenceOfTheLambs.FashionistaClothes] = QuestState.SilenceOfTheLambs.FashionistaClothes.BringLeatherToLecter,
					},
				},
			})
	end)
	...
	:State(function()
		return QuestState.SilenceOfTheLambs.FashionistaClothes.BringLeatherToLecter,
			QuestFactory.Dialog("Lecter", {
				[{ "mission", "misja" }] = {
					...
					nextState = {
						[Storage.SilenceOfTheLambs.FashionistaClothes] = QuestState.SilenceOfTheLambs.FashionistaClothes.AskLecterForNewMission,
					},
				},
			})
	end)
	:State(function()
		return QuestState.SilenceOfTheLambs.FashionistaClothes.AskLecterForNewMission,
			QuestFactory.Dialog("Lecter", {
				[{ "mission", "misja" }] = {
					...
					nextState = {
						[Storage.SilenceOfTheLambs.FashionistaClothes] = QuestState.SilenceOfTheLambs.RubMeatWithLecter.BringHeartsToLecter,
					},
				},
			})
	end)
