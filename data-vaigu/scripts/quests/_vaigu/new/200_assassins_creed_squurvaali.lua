	...
	:Constant(function()
		ASSASSINS_CREED_SKURWOALA_SPECIAL_ACTIONS = {
			...
			aunorTeleportOut = function(context)
				local player = context.player
				if player then
					player:teleportTo(Position(7228, 1531, 5))
		...
		return QuestState.AssassinsCreedSquurvaali.Mission04.FireFlare,
			...
			QuestFactory.Script(function(missionState)
				local updateStorages = {
					[Storage.AssassinsCreedSquurvaali.Mission04] = QuestState.AssassinsCreedSquurvaali.Mission04.ReportToGhasstlyPrincess,
				}
