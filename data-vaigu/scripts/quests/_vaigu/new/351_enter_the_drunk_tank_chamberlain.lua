...
quest
	...
	:State(
		QuestState.EnterTheDrunkTankChamberlain.Mission01.AskVislavAboutTask,
	...
	:State(
		QuestState.EnterTheDrunkTankChamberlain.Mission01.CollectWaterAndMilk,
	...
	:State(
		QuestState.EnterTheDrunkTankChamberlain.Mission01.UseHallucinogenInCatacombs,
	...
	:State(
		QuestState.EnterTheDrunkTankChamberlain.Mission01.ReportToVislav,
		QuestFactory.Dialog("Vislav Shivka", {
			[{ "mission", "misja" }] = {
