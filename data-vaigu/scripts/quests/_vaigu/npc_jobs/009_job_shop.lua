...
JOB_SHOPS = {
	...
	[JOB_CREATURE_PRODUCT] = {
		...
		{ itemName = "blank parchment", clientId = 2817, buy = 8 },
		...
		{ itemName = "golden dragon tapestry", clientId = 23723, buy = 80 },
	...
	[JOB_TASKS] = {
		{ itemName = "book", clientId = 2837, buy = 15 },
		{ itemName = "book", clientId = 2838, buy = 15 },
		{ itemName = "book", clientId = 2839, buy = 15 },
		...
		{ itemName = "christmas present", clientId = 6505, buy = 20 },
		{ itemName = "christmas present", clientId = 6509, buy = 20 },
		...
		{ itemName = "Dragha's spellbook", clientId = 6120, buy = 150 },
		...
		{ itemName = "ranger's cloak", clientId = 3571, buy = 550 },
		...
		{ itemName = "stone table", clientId = 2347, buy = 30 },
		...
		{ itemName = "book", clientId = 2843, sell = 60 },
		{ itemName = "book", clientId = 2844, sell = 40 },
		{ itemName = "book", clientId = 2846, sell = 15 },
		...
		{ itemName = "music sheet", clientId = 6088, sell = 250 },
		{ itemName = "music sheet", clientId = 6089, sell = 400 },
		{ itemName = "music sheet", clientId = 6090, sell = 800 },
		...
		{ itemName = "empty jug", clientId = 7243, buy = 10 },
		...
		{ itemName = "swarmer drum", clientId = 14253, buy = 140 },
