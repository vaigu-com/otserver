...
pseudoQuest
	...
	:Script(function()
		...
		[{ "wildcard", "card", "prey wildcard", "prey", "karta" }] = {
			...
			specialRequirements = {
				{
					requirement = SPECIAL_REQUIREMENTS_UNIVERSAL.saidPositiveInteger,
					requiredOutcome = true,
					textFailedRequirement = "You need to tell me the number of wildcards you'd like to buy.",
				},
			},
		...
		[{ "yes", "tak" }] = {
			...
			specialRequirements = {
				{
					requirement = SPECIAL_REQUIREMENTS_WILDCARD.hasMoneyForWildcards,
					requiredOutcome = true,
			...
			[JOB_TASKS] = {
				...
				[{ "tasks", "taski", "biore", "task", "taskow" }] = {
					...
					specialRequirements = {
						{
							requirement = SPECIAL_REQUIREMENTS_TASKS.canTakeAnotherTask,
							requiredOutcome = true,
				...
				[{ "zakoncz", "koniec", "cancel", "anuluj", "Anuluj" }] = {
					...
					specialRequirements = {
						{
							requirement = SPECIAL_REQUIREMENTS_TASKS.hasAnyOngoingTask,
							requiredOutcome = true,
