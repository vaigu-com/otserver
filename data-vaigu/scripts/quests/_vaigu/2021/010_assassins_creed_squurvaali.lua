...
quest
	...
	:Questlog(function()
		Quests[NextQuestId()] = {
			...
			missions = {
				[Storage.AssassinsCreedSquurvaali.PuzzlesDoneStateBinary] = {
				...
				[Storage.AssassinsCreedSquurvaali.Mission03] = {
					...
					states = {
						...
						[QuestState.AssassinsCreedSquurvaali.Mission03.Finished] = "You delivered the materials needed for 'enchanting' the carpet to Djinn. From now on, you will be able to fly from the highest mountain in the Caribbean.",
					},
				},
				[Storage.AssassinsCreedSquurvaali.Mission04] = {
					...
					states = {
						...
						[QuestState.AssassinsCreedSquurvaali.Mission04.Finished] = "Father Natanek informed you about the dire consequences of the King of the Crypt victory.",
					},
				},
			},
		}
	...
	:Mission(Storage.AssassinsCreedSquurvaali.PuzzlesDoneStateBinary)
	:State(
		MISSION_NOT_STARTED,
		QuestFactory.Dialog("Ghasstly Princess", {
			...
			[{ "heaven", "nieba" }] = {
				...
				nextState = {
					[Storage.AssassinsCreedSquurvaali.PuzzlesDoneStateBinary] = 1,
				},
			},
		}),
	...
	:State(
		...
		QuestFactory.Dialog("Father Natanek", {
			[{ "mission", "duch", "Ghasstly Princess", "ghasstly princess" }] = {
				...
				nextState = {
					[Storage.AssassinsCreedSquurvaali.PuzzlesDoneStateBinary] = 2,
				},
			},
		})
	)
	...
	:State(
		...
		QuestFactory.Dialog("Ghasstly Princess", {
			[{ "mission", "carpet", "dywan" }] = {
				...
				nextState = {
					[Storage.AssassinsCreedSquurvaali.PuzzlesDoneStateBinary] = 4,
		...
		QuestFactory.StartupItems({
			{
				...
				nextState = { [Storage.AssassinsCreedSquurvaali.Mission03] = 3 },
			},
		})
	)
	:State(
		...
		QuestFactory.Dialog("Lambor", {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.AssassinsCreedSquurvaali.Mission03] = 4,
				},
			},
		})
	)
	:State(
		...
		QuestFactory.Dialog("Lambor", {
			[{ "mission" }] = {
				...
				nextState = {
					[Storage.AssassinsCreedSquurvaali.Mission03] = 5,
	...
	:State(
		...
		QuestFactory.Script(function(missionState)
			local updateStorages = {
				[Storage.AssassinsCreedSquurvaali.Mission04] = 3,
			}
