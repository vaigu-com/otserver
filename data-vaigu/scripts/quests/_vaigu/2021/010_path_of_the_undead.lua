...
quest
	...
	:Questlog(function()
		Quests[NextQuestId()] = {
			...
			missions = {
				[Storage.PathOfTheUndead.PuzzlesDoneStateBinary] = {
					...
					states = {
						...
						[QuestState.PathOfTheUndead.Mission01.Finished] = "Gandalf promised to bless your cause, but first, you must visit special magical circles.",
					},
				},
				[Storage.PathOfTheUndead.Mission02] = {
					...
					states = {
						...
						[QuestState.PathOfTheUndead.Mission02.Finished] = "Gandalf has blessed you and advised you to go to Konmuld for further instructions.",
					},
				},
				[Storage.PathOfTheUndead.Mission03] = {
					...
					states = {
						...
						[QuestState.PathOfTheUndead.Mission03.Finished] = "Gandalf misplaced a certain item intended as a reward, but you have received his other gifts.",
					},
				},
			},
		}
	...
	:Mission(Storage.PathOfTheUndead.PuzzlesDoneStateBinary)
	:State(
		MISSION_NOT_STARTED,
		QuestFactory.Dialog("Gandalf", {
			[{ "oprocz tego ludzie", "aside from that people" }] = {
				...
				nextState = {
					[Storage.PathOfTheUndead.PuzzlesDoneStateBinary] = QuestState.PathOfTheUndead.Mission01.ConsultGandalf,
				},
				requiredState = {
	...
	:State(
		...
		QuestFactory.Dialog("Gandalf", {
			...
			[{ "conditions", "warunki" }] = {
				...
				nextState = {
					[Storage.PathOfTheUndead.PuzzlesDoneStateBinary] = QuestState.PathOfTheUndead.Mission01.Finished,
	...
	:State(
		...
		QuestFactory.Dialog("Hermione", {
			[{ "krag", "kregi", "circles", "cromlech" }] = {
				text = "I knew this moment would come. Cromlech is located in the very west of the island. It's defended by the Undead",
			},
		}),
		QuestFactory.Dialog("Funfel", { [{ "krag", "kregi", "circles", "cromlech" }] = {
			text = "This cromlech is located behind the orc hill in the west of the city. There's also corym village nearby.",
		} }),
		QuestFactory.Dialog("PH_NAME", { [{ "krag", "kregi", "circles", "cromlech" }] = {
