...
quest
	...
	:Questlog(function()
		Quests[NextQuestId()] = {
			...
			missions = {
				[Storage.ChesterTheDwarf.PuzzlesDoneStateBinary] = {
	...
	:Mission(Storage.ChesterTheDwarf.PuzzlesDoneStateBinary)
	:State(
		...
		QuestFactory.Dialog("Chester the Dwarf", {
			...
			[{ "mission", "yes", "tak" }] = {
				...
				nextState = {
					[Storage.ChesterTheDwarf.PuzzlesDoneStateBinary] = QuestState.ChesterTheDwarf.Mission01.Finished,
