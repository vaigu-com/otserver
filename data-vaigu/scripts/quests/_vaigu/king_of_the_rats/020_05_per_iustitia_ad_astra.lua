...
quest
	:Storage(function()
		...
		QuestState.PerIustitiaAdAstra = {
			...
			Mission05 = {
				FindBeachLurker = 1,
				ReportToHugo = 2,
				FindArtifactAndBringItToAstralJanus = 3,
				Finished = 4,
			},
		}
			...
			missions = {
				[Storage.PerIustitiaAdAstra.Mission01] = {
					...
					states = {
						...
						[QuestState.PerIustitiaAdAstra.Mission01.Finished] = "Qasim catapulted your ship to the orbit. Try to board it through teleporting device.",
					},
				},
				[Storage.PerIustitiaAdAstra.Mission02] = {
					...
					states = {
						...
						[QuestState.PerIustitiaAdAstra.Mission02.Finished] = "You returned crate to Swagger.",
					},
				},
				[Storage.PerIustitiaAdAstra.Mission03] = {
					...
					states = {
						...
						[QuestState.PerIustitiaAdAstra.Mission03.HeadToHugoPlanet] = "Head to Hugo planet and tell him about the mission you have been assigned.",
					},
				},
				[Storage.PerIustitiaAdAstra.Mission04] = {
					...
					states = {
						...
						[QuestState.PerIustitiaAdAstra.Mission04.Improvise] = "Hugo noticed that your accent is off, also he knew the person you are impersonating. Improvise.",
						...
						[QuestState.PerIustitiaAdAstra.Mission04.Finished] = "Hugo asked you to deal with something lurking in southern beach.",
					},
				},
				[Storage.PerIustitiaAdAstra.Mission05] = {
					...
					states = {
						...
						[QuestState.PerIustitiaAdAstra.Mission05.FindArtifactAndBringItToAstralJanus] = "Your job is finished. Report to Astral Janus.",
		...
		QuestFactory.StartupItems({
			{
				...
				requiredState = {
					[Storage.PerIustitiaAdAstra.Mission01] = 4,
				},
			},
		}),
		QuestFactory.Dialog("Qasim", {
		...
		QuestFactory.StartupItems({
			{
				...
				requiredState = {
					[Storage.PerIustitiaAdAstra.Mission01] = 5,
				},
			},
			{
		...
		QuestFactory.StartupItems({
			{
				...
				requiredState = { [Storage.PerIustitiaAdAstra.Mission01] = 8 },
				nextState = { [Storage.PerIustitiaAdAstra.Mission01] = 9, [Storage.PerIustitiaAdAstra.Mission03] = 4 },
			},
		}, GANYMEDE_ANCHOR)
	)
	:State(
		...
		QuestFactory.StartupItems({
			{
				...
				nextState = { [Storage.PerIustitiaAdAstra.Mission01] = 12, [Storage.PerIustitiaAdAstra.Mission05] = 3 },
			},
		...
		QuestFactory.StartupItems({
			{
				...
				nextState = { [Storage.PerIustitiaAdAstra.Mission01] = 19, [Storage.PerIustitiaAdAstra.Mission05] = 4 },
			},
	...
	:State(
		QuestState.PerIustitiaAdAstra.Mission05.FindArtifactAndBringItToAstralJanus,
		QuestFactory.Dialog("Astral Janus", {
			[{ "mission", "misja" }] = {
	...
	:State(
		{ min = QuestState.PerIustitiaAdAstra.Mission05.FindArtifactAndBringItToAstralJanus },
		QuestFactory.StartupItems({
			{
