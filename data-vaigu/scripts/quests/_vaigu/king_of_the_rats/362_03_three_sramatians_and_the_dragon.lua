...
quest
		...
		return ANY_STATE,
			QuestFactory.Script(function(missionState)
				...
				local function hasRequiredState(player, aid)
					local questState = player:getStorageValueByKey(Storage.ThreeSramatiansAndTheDragon.Mission01)
		...
		return QuestState.ThreeSramatiansAndTheDragon.Mission04.FindCompanyAtSteppes,
			QuestFactory.Script(function(missionState)
				...
				function FirePlace.onUse(player, item, fromPosition, target, toPosition, isHotkey)
					...
					if player:getStorageValueByKey(Storage.ThreeSramatiansAndTheDragon.Mission01) ~= QuestState.ThreeSramatiansAndTheDragon.Mission04.FindCompanyAtSteppes then
						return false
					end
		...
		return QuestState.ThreeSramatiansAndTheDragon.Mission04.StealWineFromVampires,
			QuestFactory.Script(function(missionState)
				...
				function vampireKidnapping.onStepIn(player, item, position, fromPosition)
					...
					if player:getStorageValueByKey(Storage.ThreeSramatiansAndTheDragon.Mission01) ~= QuestState.ThreeSramatiansAndTheDragon.Mission04.StealWineFromVampires then
						return false
					end
		...
		return QuestState.ThreeSramatiansAndTheDragon.Mission08.FindAndDefeatHfpx,
			...
			QuestFactory.Script(function(missionState)
				...
				function tileIn.onStepIn(player, item, fromPosition, target, toPosition, isHotkey)
					...
					local mission07state = player:getStorageValueByKey(Storage.ThreeSramatiansAndTheDragon.Mission07)
					local mission08state = player:getStorageValueByKey(Storage.ThreeSramatiansAndTheDragon.Mission08)
	...
	:State(function()
		return QuestState.ThreeSramatiansAndTheDragon.Mission08.ReportToRatOfKings, QuestFactory.Dialog("Rat of Kings", {
			[{ "mission" }] = {
