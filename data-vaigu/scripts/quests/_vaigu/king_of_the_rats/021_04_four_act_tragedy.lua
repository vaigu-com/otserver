...
quest
			...
			missions = {
				[Storage.FourActTragedy.PuzzlesDoneStateBinary] = {
					...
					states = {
						...
						[QuestState.FourActTragedy.Mission01.Finished] = "Romek sent you to Knurow. Try to find a way to go back in time there.",
					},
				},
				[Storage.FourActTragedy.Mission02] = {
					...
					states = {
						...
						[QuestState.FourActTragedy.Mission02.Finished] = "You told romek about Timmy work.",
					},
				},
				[Storage.FourActTragedy.Mission03] = {
					name = "03. Master Baitor",
					states = {
						[QuestState.FourActTragedy.Mission03.FindLewiatan] = "Romek asked you to buy him a beer at nearby Lewiatan.",
						[QuestState.FourActTragedy.Mission03.ReportToRomek] = "You defeated the kraken. Go back to Romek.",
						[QuestState.FourActTragedy.Mission03.Finished] = "Find slippers bitten by the Rat Bum. Romek mentioned northern rat collaborators as his allies.",
					},
				},
				[Storage.FourActTragedy.Mission04] = {
					...
					states = {
						...
						[QuestState.FourActTragedy.Mission04.Finished] = "Ask Xena for possible usage for Grazhenacore.",
					},
				},
				[Storage.FourActTragedy.Mission05] = {
					name = "06. Sic transit gloria mundi",
					states = {
						[QuestState.FourActTragedy.Mission05.FindXena] = "Ask Xena for possible usage for Grazhenacore.",
						...
						[QuestState.FourActTragedy.Mission05.Finished] = "You helped Romek in dealing with Rat Bum. He rewarded you for your effort.",
					},
				},
			},
		}
	...
	:State(
		QuestState.FourActTragedy.Mission03.FindLewiatan,
		QuestFactory.Dialog("GM Romek", {
			[{ "mission" }] = {
