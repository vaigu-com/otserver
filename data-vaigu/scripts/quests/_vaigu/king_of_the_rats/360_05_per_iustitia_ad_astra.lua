		...
		return QuestState.PerIustitiaAdAstra.Mission01.HeadToHighestMountain,
			...
			QuestFactory.Script(function(missionState)
				...
				function tileIn.onStepIn(player, item, fromPosition, target, toPosition, isHotkey)
					...
					local mission01State = player:getStorageValueByKey(Storage.PerIustitiaAdAstra.Mission01)
					local mission05State = player:getStorageValueByKey(Storage.PerIustitiaAdAstra.Mission05)
		...
		return QuestState.PerIustitiaAdAstra.Mission02.BoardShipInDeeplingTemple,
			...
			QuestFactory.Script(function(missionState)
				...
				function deeplingTile.onStepIn(player, item, toPosition, fromPosition)
					...
					if player:getStorageValueByKey(Storage.PerIustitiaAdAstra.Mission01) == 6 then
			...
			QuestFactory.Script(function(missionState)
				...
				function enterShipTile.onStepIn(player, item, toPosition, fromPosition)
					...
					if player:getStorageValueByKey(Storage.PerIustitiaAdAstra.Mission01) < 7 then
						return false
					end
			...
			QuestFactory.Script(function(missionState)
				...
				function exitDevice.onStepIn(player, _, _, _)
					...
					local aid = player:getStorageValueByKey(Storage.PerIustitiaAdAstra.ShipControl.Current)
				...
				local confirmChoice = function(player, button, choice)
					...
					player:setStorageValueByKey(Storage.PerIustitiaAdAstra.ShipControl.Next, choice.aid)
				...
				local function flightTimerLoop()
					if os.time() > getStorageValueByKey(Storage.PerIustitiaAdAstra.ShipControl.FlightTimer) then
				...
				function shipWheel.onUse(player, item, fromPosition, target, toPosition, isHotkey)
					...
					local nextDestAid = player:getStorageValueByKey(Storage.PerIustitiaAdAstra.ShipControl.Next)
					setStorageValueByKey(Storage.PerIustitiaAdAstra.ShipControl.FlightTimer, os.time() + travelTime / 1000)
					player:setStorageValueByKey(Storage.PerIustitiaAdAstra.ShipControl.FlightTimer, os.time() + travelTime / 1000)
					player:setStorageValueByKey(Storage.PerIustitiaAdAstra.ShipControl.Current, nextDestAid)
		...
		return QuestState.PerIustitiaAdAstra.Mission04.FindHammer_RepairPipes,
			...
			QuestFactory.Script(function(missionState)
				...
				function item.onUse(player, hammer, fromPosition, pipe, toPosition, isHotkey)
					...
					if player:getStorageValueByKey(Storage.PerIustitiaAdAstra.Mission01) ~= 20 then
						return false
					end
		...
		return QuestState.PerIustitiaAdAstra.Mission04.FindOldChest,
			...
			QuestFactory.Script(function(missionState)
				...
				local function canOpenChest(player, toPosition)
					if player:getStorageValueByKey(Storage.PerIustitiaAdAstra.Mission01) ~= 22 then
						return false
					end
	...
	:MonsterEvent(function()
		...
		function rukca.onDeath(creature)
			onDeathForDamagingPlayers(creature, function(creature, player)
				...
				player:setStorageValueByKey(updateStorages, QuestState.PerIustitiaAdAstra.Mission05.ReportToHugo)
			end)
			return true
		end
...
QuestFactory.Script(function(missionState)
	...
	starLeftStepIn:key(Storage.PerIustitiaAdAstra.MovingStarTile)
...
QuestFactory.Script(function(missionState)
	...
	rukcaLever:key(rukcaConfig.actionid)
	rukcaLever:register()
...
QuestFactory.Script(function(missionState)
	...
	saltyTile:key(Storage.PerIustitiaAdAstra.SaltyTile)
	saltyTile:register()
end)
