...
function ferumbrasAscendantMysterious.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if player:getStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.RiftRunner) >= 1 or player:getStorageValueByKey(24850) < 1 then
		...
		player:setStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.RiftRunner, 1)
	end
	return true
end
