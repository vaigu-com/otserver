...
function ferumbrasAscendantTarbazNotes.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.actionid == 54388 then
		if player:getStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.BasinCounter) ~= 8 then
			return false
		end
		...
		player:setStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.TarbazNotes, 1)
	elseif item.actionid == 54389 then
		if player:getStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.BasinCounter) ~= 8 and player:getStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.TarbazNotes) < 1 then
			return false
		end
		...
		player:setStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.TarbazNotes, 2)
	end
