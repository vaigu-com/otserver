...
function vortex.onStepIn(creature, item, position, fromPosition)
	...
	player:setStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.FerumbrasEssence, player:getStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.FerumbrasEssence) + 1)
	if player:getStorageValueByKey(Storage.Quest.U10_90.FerumbrasAscension.FerumbrasEssence) >= 8 then
