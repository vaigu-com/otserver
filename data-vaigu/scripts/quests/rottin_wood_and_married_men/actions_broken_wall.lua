...
function rottinWoodBroken.onUse(player, item, fromPosition, itemEx, toPosition, isHotkey)
	...
	if player:getStorageValueByKey(Storage.Quest.U8_7.RottinWoodAndTheMarriedMen.RottinStart) < 6 then
		player:setStorageValueByKey(Storage.Quest.U8_7.RottinWoodAndTheMarriedMen.RottinStart, 6)
