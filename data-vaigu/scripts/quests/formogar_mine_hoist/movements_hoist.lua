...
function hoist.onStepIn(creature, item, position, fromPosition)
	...
	if player:getStorageValueByKey(Storage.QuestChests.FormorgarMinesHoistSkeleton) ~= 1 or player:getStorageValueByKey(Storage.QuestChests.FormorgarMinesHoistChest) ~= 1 then
