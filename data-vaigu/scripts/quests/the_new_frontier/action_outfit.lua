...
function theNewFrontierOutfit.onUse(player, item)
	if player:getStorageValueByKey(TheNewFrontier.Questline) == 26 then
		player:addOutfit(335, 0)
		player:addOutfit(336, 0)
		player:setStorageValueByKey(TheNewFrontier.Mission09.RewardDoor, 1)
		player:setStorageValueByKey(TheNewFrontier.Questline, 27)
