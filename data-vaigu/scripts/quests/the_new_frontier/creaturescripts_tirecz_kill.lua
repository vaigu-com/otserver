...
function tireczKill.onDeath(creature)
	...
	for i = 1, #spectators do
		...
		if spectator:getStorageValueByKey(TheNewFrontier.Questline) == 25 then
			spectator:setStorageValueByKey(TheNewFrontier.Mission09[1], 2) -- Questlog: 'Mission 09: Mortal Combat'
			spectator:setStorageValueByKey(TheNewFrontier.Questline, 26)
		end
	end
