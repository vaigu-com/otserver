...
sultanPrime
	...
	:State(MissionState.SultanPrime.Mission01.Start)
	...
	:State(MissionState.SultanPrime.Mission01.GivingAmuletToSultan)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
			text = "Adventurer |PLAYERNAME|... I was watching you proceed through that dungeon and beat all the deadly traps. You might have something that I value. Precisely that {amulet} that u took from Cezary Baryka.",
		},
	...
	:State(MissionState.SultanPrime.Mission02.Start)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
	...
	:State(MissionState.SultanPrime.Mission02.PoisoningMagicianWell)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
	...
	:State(MissionState.SultanPrime.Mission02.CullingOfCamels)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
	...
	:State(MissionState.SultanPrime.Mission02.HangTheFarmer)
	:Dialog("Dampreefer", {
		[{ GREET }] = {
	...
	:State(MissionState.SultanPrime.Mission02.ReportHanging)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
	...
	:State(MissionState.SultanPrime.Mission03.Start)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
	...
	:State(MissionState.SultanPrime.Mission03.TentacleFeeding)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
			text = "DETECTED |PLAYERNAME|. EXECUTE: GREET ON OBJECT $|PLAYERNAME|.",
		},
	...
	:State(MissionState.SultanPrime.Mission03.KillingRyba)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
			text = "DETECTED |PLAYERNAME|. EXECUTE: GREET ON OBJECT $|PLAYERNAME|.",
		},
	...
	:State(MissionState.SultanPrime.Mission03.ReportKillingRyba)
	:Dialog("Sultan of Phantasms", {
		[{ GREET }] = {
	...
	:State(MissionState.SultanPrime.Mission03.ReportToNatanek)
