	...
	for i = 1, #spectators do
		...
		if spec:isPlayer() then
			if creature:getName():lower() == "somewhat beatable" then
				if spec:getStorageValueByKey(Storage.Quest.U11_02.TheFirstDragon.SomewhatBeatable) < 5 then
					spec:setStorageValueByKey(Storage.Quest.U11_02.TheFirstDragon.SomewhatBeatable, spec:getStorageValueByKey(Storage.Quest.U11_02.TheFirstDragon.SomewhatBeatable) + 1)
				end
			end
			if spec:getStorageValueByKey(Storage.Quest.U11_02.TheFirstDragon.SomewhatBeatable) == 5 then
				for b = 1, 6 do
