...
function pirate.onStepIn(creature, item, position, fromPosition)
	...
	if player:getStorageValueByKey(Storage.Quest.U8_1.SecretService.TBIMission03) == 1 then
		player:setStorageValueByKey(Storage.Quest.U8_1.SecretService.TBIMission03, 2)
