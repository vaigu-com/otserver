...
function secretServiceRing.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if player:getStorageValueByKey(Storage.Quest.U8_1.SecretService.TBIMission05) == 1 then
		player:setStorageValueByKey(Storage.Quest.U8_1.SecretService.TBIMission05, 2)
		item:remove()
