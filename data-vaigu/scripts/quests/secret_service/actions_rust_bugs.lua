...
function secretServiceBugs.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if player:getStorageValueByKey(Storage.Quest.U8_1.SecretService.CGBMission03) == 1 then
		player:setStorageValueByKey(Storage.Quest.U8_1.SecretService.CGBMission03, 2)
		item:remove()
