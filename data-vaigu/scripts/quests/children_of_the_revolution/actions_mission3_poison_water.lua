...
function childrenPoison.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if player:getStorageValueByKey(Storage.Quest.U8_54.ChildrenOfTheRevolution.Questline) == 10 then
		player:setStorageValueByKey(Storage.Quest.U8_54.ChildrenOfTheRevolution.Questline, 11)
		player:setStorageValueByKey(Storage.Quest.U8_54.ChildrenOfTheRevolution.Mission03, 2) --Questlog, Children of the Revolution "Mission 3: Zee Killing Fieldzz"
		item:remove()
