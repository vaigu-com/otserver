...
function childrenGrease.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if player:getStorageValueByKey(Storage.Quest.U8_54.ChildrenOfTheRevolution.Questline) == 14 then
		...
		if Tile(puzzlePositions[1]):getItemById(9933) and Tile(puzzlePositions[2]):getItemById(9936) and Tile(puzzlePositions[3]):getItemById(9939) and Tile(puzzlePositions[4]):getItemById(9938) then
			...
			player:setStorageValueByKey(Storage.Quest.U8_54.ChildrenOfTheRevolution.Questline, 17)
			player:setStorageValueByKey(Storage.Quest.U8_54.ChildrenOfTheRevolution.Mission04, 5)
		end
