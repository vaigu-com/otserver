...
function adventurersGuildHunt.onDeath(creature, _corpse, _lastHitKiller, mostDamageKiller)
	...
	onDeathForParty(creature, mostDamageKiller, function(creature, player)
		player:setStorageValueByKey(Storage.AdventurersGuild.GreatDragonHunt.DragonCounter, math.max(0, player:getStorageValueByKey(Storage.AdventurersGuild.GreatDragonHunt.DragonCounter)) + 1)
	end)
	return true
end
