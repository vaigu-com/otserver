...
function wrathEmperorMiss1Light.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if fromPosition == Position(positions[1]) then
		if Game.getStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Light01) ~= 1 then
			Game.setStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Light01, 1)
			addEvent(Game.setStorageValueByKey, 20 * 1000, Storage.Quest.U8_6.WrathOfTheEmperor.Light01, 0)
			local pos = {
	...
	elseif fromPosition == Position(positions[2]) then
		if Game.getStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Light02) ~= 1 then
			Game.setStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Light02, 1)
			addEvent(Game.setStorageValueByKey, 20 * 1000, Storage.Quest.U8_6.WrathOfTheEmperor.Light02, 0)
			local pos = {
	...
	elseif fromPosition == Position(positions[3]) then
		if Game.getStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Light04) ~= 1 then
			Game.setStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Light04, 1)
			addEvent(Game.setStorageValueByKey, 20 * 1000, Storage.Quest.U8_6.WrathOfTheEmperor.Light04, 0)
			local wallItem, pos
			for i = 1, 4 do
	...
	elseif fromPosition == Position(positions[4]) then
		if Game.getStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Light03) ~= 1 then
			Game.setStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Light03, 1)
			addEvent(Game.setStorageValueByKey, 20 * 1000, Storage.Quest.U8_6.WrathOfTheEmperor.Light03, 0)
