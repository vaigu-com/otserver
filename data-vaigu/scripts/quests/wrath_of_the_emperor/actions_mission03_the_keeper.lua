local function revertKeeperstorage()
	Game.setStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Mission03, 0)
end
...
function wrathEmperorMiss3Keeper.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 11364 and target.actionid == 8026 then
		if Game.getStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Mission03) < 5 then
			Game.setStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Mission03, math.max(0, Game.getStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Mission03)) + 1)
		...
		elseif Game.getStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Mission03) == 5 then
			player:removeItem(11364, 1)
			Game.setStorageValueByKey(Storage.Quest.U8_6.WrathOfTheEmperor.Mission03, 6)
