...
function hunterAll.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if player:getStorageValueByKey(Storage.Quest.U7_8.HunterOutfits.HunterMusicSheet01) == 1 and player:getStorageValueByKey(Storage.Quest.U7_8.HunterOutfits.HunterMusicSheet02) == 1 and player:getStorageValueByKey(Storage.Quest.U7_8.HunterOutfits.HunterMusicSheet03) == 1 and player:getStorageValueByKey(Storage.Quest.U7_8.HunterOutfits.HunterMusicSheet04) == 1 then
