local function createSpawnAnomalyRoom(valueGlobalStorage)
	...
	Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.ChargedAnomaly, valueGlobalStorage + 1)
end
...
function anomalyTransform.onThink(creature)
	...
	local anomalyGlobalStorage = Game.getStorageValueByKey(GlobalStorage.HeartOfDestruction.ChargedAnomaly)
