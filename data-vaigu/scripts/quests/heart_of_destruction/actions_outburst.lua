local config = {
	...
	onUseExtra = function()
		Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.OutburstStage, 0)
		Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.OutburstHealth, 290000)
