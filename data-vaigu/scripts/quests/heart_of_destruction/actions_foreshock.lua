local config = {
	...
	onUseExtra = function()
		Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.ForeshockHealth, 105000)
		Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.AftershockHealth, 105000)
		Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.ForeshockStage, -1)
		Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.AftershockStage, -1)
