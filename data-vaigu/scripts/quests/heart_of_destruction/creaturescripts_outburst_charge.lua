local function createSpawnChargingOutburst(stage)
	...
	Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.OutburstStage, stage)
	Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.OutburstChargingKilled, -1)
end
...
function outburstCharge.onThink(creature)
	...
	local outburstStage = Game.getStorageValueByKey(GlobalStorage.HeartOfDestruction.OutburstStage) > 0 and Game.getStorageValueByKey(GlobalStorage.HeartOfDestruction.OutburstStage) or 0
	Game.setStorageValueByKey(GlobalStorage.HeartOfDestruction.OutburstHealth, creature:getHealth())
