...
local raidData = {
	...
	LuaRaid("Supply_1"):Context({
		perDay = 0.648,
		waves = {
			Wave(1):Creature("Supply Dragon", Area(Position(5738, 1295, 6), Position(6114, 1952, 7)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 0,
	}),
	LuaRaid("Gobliny"):Context({
		perDay = 0.72,
		waves = {
			Wave(10):Creature("Goblin", Area(Position(5894, 1678, 7), Position(5935, 1773, 7)), 30, true):Creature("Goblin Assassin", Area(Position(5894, 1678, 7), Position(5935, 1773, 7)), 18, true):Creature("Goblin Scavenger", Area(Position(5894, 1678, 7), Position(5935, 1773, 7)), 15, true),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Countess_Sorrow"):Context({
		perDay = 0.4752,
		waves = {
			Wave(10):Creature("Countess Sorrow", Area(Position(6116, 1938, 15), Position(6116, 1938, 15)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Bane_of_Light"):Context({
		perDay = 0.648,
		waves = {
			Wave(10):Creature("Bane of Light", Area(Position(7674, 1407, 7), Position(7674, 1407, 7)), 1, false),
		},
		cooldown = 10800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Dreadmaw"):Context({
		perDay = 0.72,
		waves = {
			Wave(10):Creature("Dreadmaw", Area(Position(6454, 973, 8), Position(6454, 973, 8)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("The_Welter"):Context({
		perDay = 0.216,
		waves = {
			Wave(10):Creature("The Welter", Area(Position(6686, 507, 6), Position(6686, 507, 6)), 1, true):Notification(-9, "A black, three-headed monstrosity has appeared in the forgotten ruins of the jungle!"),
		},
		cooldown = 57600,
		minPlayersOnline = 1,
	}),
	LuaRaid("Horestis"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("Horestis", Area(Position(7119, 1074, 10), Position(7119, 1074, 10)), 1, false),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Tyrn"):Context({
		perDay = 0.8,
		waves = {
			Wave(10):Creature("Tyrn", Area(Position(6628, 585, 4), Position(6628, 585, 4)), 1, false),
		},
		cooldown = 57600,
		minPlayersOnline = 1,
	}),
	LuaRaid("Ribstride"):Context({
		perDay = 1.5,
		waves = {
			Wave(10):Creature("Bonebeast", Area(Position(6905, 1232, 7), Position(6966, 1279, 7)), 35, true):Creature("Ribstride", Area(Position(6905, 1232, 7), Position(6966, 1279, 7)), 1, true),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Sulphur_Scuttler"):Context({
		perDay = 0.72,
		waves = {
			Wave(10):Creature("Sulphur Scuttler", Area(Position(6602, 1363, 9), Position(6602, 1363, 9)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Ghazbaran"):Context({
		perDay = 0.1728,
		waves = {
			Wave(800):Creature("Deathslicer", Area(Position(6349, 1763, 14), Position(6401, 1809, 14)), 12, true):Notification(-799, "Primordial evil is awakening deep in the mines of Syberia."):Notification(-200, "Demonic entities begin to appear in the deepest mines of Syberia."),
			Wave(900):Creature("Juggernaut", Area(Position(6349, 1763, 14), Position(6401, 1809, 14)), 1, true):Notification(-1, "Demonic entities begin to appear in the deepest mines of Syberia."),
			Wave(1000):Creature("Fury", Area(Position(6349, 1763, 14), Position(6401, 1809, 14)), 1, true),
			Wave(1100):Creature("Demon", Area(Position(6349, 1763, 14), Position(6401, 1809, 14)), 1, true),
			Wave(1200):Creature("Ghazbaran", Area(Position(6377, 1774, 14), Position(6377, 1774, 14)), 1, true):Notification(-1, "The Demonic Master has revealed himself in the mines of Syberia"),
		},
		cooldown = 144000,
		minPlayersOnline = 5,
	}),
	LuaRaid("Morgaroth"):Context({
		perDay = 0.1872,
		waves = {
			Wave(360):Creature("Demon", Area(Position(6713, 1143, 10), Position(6749, 1173, 10)), 7, true):Notification(-359, "Strange footsteps can be heard in the north of the Hurghada desert."),
			Wave(720):Creature("Morgaroth", Area(Position(6728, 1158, 10), Position(6728, 1158, 10)), 1, true):Notification(-360, "The presence of mythical evil can be sensed near the extinct volcano in the desert."):Notification(-1, "Morgaroth has activated the volcano and revealed himself in its depths!"),
		},
		cooldown = 144000,
		minPlayersOnline = 5,
	}),
	LuaRaid("Zoralurk"):Context({
		perDay = 0.1872,
		waves = {
			Wave(360):Creature("Demon", Area(Position(7677, 1370, 15), Position(7719, 1418, 15)), 7, true):Notification(-359, ""),
			Wave(720):Creature("Zoralurk", Area(Position(7700, 1396, 15), Position(7700, 1396, 15)), 1, true):Notification(-360, ""):Notification(-1, ""),
		},
		cooldown = 144000,
		minPlayersOnline = 5,
	}),
	LuaRaid("Dracola"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("Dracola", Area(Position(6139, 1875, 15), Position(6139, 1875, 15)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Lizardape"):Context({
		...
		waves = {
			Wave(15)
				...
				:Notification(-14, "Lizardmen are trying to defend themselves against the monkeys' attack on their settlement."),
			Wave(120)
	...
	LuaRaid("OrcBp"):Context({
		perDay = 0.2304,
		waves = {
			Wave(10):Creature("Orc Sambackpack", Area(Position(5803, 1298, 7), Position(5808, 1302, 7)), 1, false),
		},
		cooldown = 21600,
		minPlayersOnline = 1,
	}),
	LuaRaid("Yaga_the_Crone"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Yaga the Crone", Area(Position(6018, 1790, 7), Position(6018, 1790, 7)), 1, false),
		},
		cooldown = 64800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Winterwolves"):Context({
		perDay = 0.504,
		waves = {
			Wave(10):Creature("Winter Wolf", Area(Position(6531, 1827, 7), Position(6565, 1862, 7)), 20, true),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Necropharus"):Context({
		perDay = 0.3168,
		waves = {
			Wave(10):Creature("Necropharus", Area(Position(6077, 1569, 12), Position(6077, 1569, 12)), 1, false),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Midnight_Panther"):Context({
		perDay = 2.304,
		waves = {
			Wave(10):Creature("Midnight Panther", Area(Position(6620, 923, 8), Position(6620, 923, 8)), 1, false):Creature("Midnight Panther", Area(Position(6633, 926, 7), Position(6633, 926, 7)), 1, false):Creature("Midnight Panther", Area(Position(6529, 935, 7), Position(6529, 935, 7)), 1, false),
		},
		cooldown = 7200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Pirates_Mirkotown"):Context({
		perDay = 0.288,
		waves = {
			Wave(10):Creature("Pirate Buccaneer", Area(Position(5966, 1495, 7), Position(6019, 1542, 7)), 12, true):Creature("Pirate Marauder", Area(Position(5966, 1495, 7), Position(6019, 1542, 7)), 10, true),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Feroxa"):Context({
		perDay = 0.216,
		waves = {
			Wave(60):Creature("Feroxa", Area(Position(6228, 1107, 8), Position(6228, 1107, 8)), 1, true):Notification(-59, "The unrest fills the air around the steppes..."):Notification(-30, "Werewolves are trying to summon their Queen regent!"),
		},
		cooldown = 86400,
		minPlayersOnline = 5,
	}),
	LuaRaid("Ancienty"):Context({
		...
		waves = {
			Wave(10)
				...
				:Notification(-9, "Ancient Scarabs surround the desert city!"),
			Wave(180)
				...
				:Creature("Scarab", Area(Position(6740, 1259, 7), Position(6773, 1326, 7)), 20, true)
				:Creature("Larva", Area(Position(6740, 1259, 7), Position(6773, 1326, 7)), 15, true),
			Wave(340):Creature("Ancient Scarab", Area(Position(6667, 1268, 7), Position(6735, 1364, 7)), 45, true):Creature("Scarab", Area(Position(6667, 1268, 7), Position(6735, 1364, 7)), 70, true):Creature("Fleshcrawler", Area(Position(6667, 1268, 7), Position(6735, 1364, 7)), 2, true):Notification(-160, "There are more and more Scarabs!"),
		},
		cooldown = 43200,
		minPlayersOnline = 5,
	}),
	LuaRaid("Dragonling"):Context({
		perDay = 0.504,
		waves = {
			Wave(1):Creature("Dragonling", Area(Position(6532, 1723, 12), Position(6525, 1699, 12)), 6, true),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Snowman_Sybir"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Animated Snowman", Area(Position(6478, 1815, 7), Position(6594, 1879, 6)), 10, false),
		},
		cooldown = 7200,
		minPlayersOnline = 1,
	}),
	LuaRaid("The_Bloodweb"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("The Bloodweb", Area(Position(6558, 1744, 8), Position(6558, 1744, 8)), 1, false),
		},
		cooldown = 10800,
		minPlayersOnline = 1,
	}),
	LuaRaid("The_Plasmother"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("The Plasmother", Area(Position(6147, 1890, 15), Position(6147, 1890, 15)), 1, false),
		},
		cooldown = 57600,
		minPlayersOnline = 1,
	}),
	LuaRaid("Weakened_Shlorg"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("weakened shlorg", Area(Position(6697, 849, 13), Position(6697, 849, 13)), 1, false),
		},
		cooldown = 64800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Old_Widow"):Context({
		perDay = 0.288,
		waves = {
			Wave(10):Creature("Giant Spider", Area(Position(5939, 1644, 7), Position(6039, 1712, 8)), 15, true):Creature("Tarantula", Area(Position(5939, 1644, 7), Position(6039, 1712, 8)), 20, true):Notification(-9, "Giant spiders have been noticed around the tarantulas' lair!"),
			Wave(240):Creature("Giant Spider", Area(Position(5939, 1644, 7), Position(6039, 1712, 8)), 30, true):Creature("Tarantula", Area(Position(5939, 1644, 7), Position(6039, 1712, 8)), 40, true):Notification(-230, "We advise against going to the hunters' camp!"),
			Wave(360):Creature("The Old Widow", Area(Position(5939, 1644, 7), Position(6039, 1712, 7)), 1, true):Creature("Giant Spider", Area(Position(5939, 1644, 7), Position(6039, 1712, 8)), 15, true):Creature("Tarantula", Area(Position(5939, 1644, 7), Position(6039, 1712, 8)), 20, true),
		},
		cooldown = 43200,
		minPlayersOnline = 5,
	}),
	LuaRaid("Supply_2"):Context({
		perDay = 0.648,
		waves = {
			Wave(1):Creature("Supply Dragon", Area(Position(6519, 1067, 7), Position(6944, 1341, 7)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 0,
	}),
	LuaRaid("Supply_6"):Context({
		perDay = 0.648,
		waves = {
			Wave(1):Creature("Supply Dragon", Area(Position(6390, 1751, 7), Position(6549, 1889, 7)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 0,
	}),
	LuaRaid("Dryad"):Context({
		perDay = 0.288,
		waves = {
			Wave(15):Creature("Forest Fury", Area(Position(5915, 1817, 7), Position(6068, 1872, 7)), 25, true):Creature("Dryad", Area(Position(5915, 1817, 7), Position(6068, 1872, 7)), 55, true):Notification(-14, "Dryads are conducting their rituals along the elf fortress."),
			Wave(125):Creature("Forest Fury", Area(Position(5981, 1918, 7), Position(6073, 1954, 7)), 15, true):Creature("Dryad", Area(Position(5981, 1918, 7), Position(6073, 1954, 7)), 35, true),
		},
		cooldown = 43200,
		minPlayersOnline = 3,
	}),
	LuaRaid("Supply_4"):Context({
		perDay = 0.648,
		waves = {
			Wave(1):Creature("Supply Dragon", Area(Position(5984, 1006, 7), Position(6329, 1297, 7)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 0,
	}),
	LuaRaid("Rottie2"):Context({
		perDay = 1.152,
		waves = {
			Wave(10):Creature("Rottie The Rotworm", Area(Position(5545, 1560, 8), Position(5545, 1560, 8)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("The_Imperor"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("The Imperor", Area(Position(6209, 1781, 15), Position(6209, 1781, 15)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Dharalion"):Context({
		perDay = 0.504,
		waves = {
			Wave(10):Creature("Dharalion", Area(Position(5739, 1663, 9), Position(5739, 1663, 9)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Zolwie"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("Tortoise", Area(Position(7010, 774, 6), Position(7066, 815, 6)), 35, true),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Zulazza"):Context({
		perDay = 0.2592,
		waves = {
			Wave(360):Creature("Chizzoron the Distorter", Area(Position(6440, 910, 4), Position(6440, 910, 4)), 1, true):Creature("Zulazza the Corruptor", Area(Position(6438, 918, 1), Position(6438, 918, 1)), 1, true):Notification(-359, "Lizardmen are trying to summon their ruler in their village!"),
			Wave(720):Notification(-360, "The Right Hand of the Lizard Ruler has already arrived in their village!"),
		},
		cooldown = 86400,
		minPlayersOnline = 5,
	}),
	LuaRaid("Furyosa"):Context({
		perDay = 0.1728,
		waves = {
			Wave(60):Creature("Furyosa", Area(Position(6258, 917, 11), Position(6258, 917, 11)), 1, true):Creature("Fury", Area(Position(6213, 898, 11), Position(6265, 931, 11)), 15, true):Notification(-59, "Furyosa has haunted the underground city of Souleaters!"),
		},
		cooldown = 86400,
		minPlayersOnline = 4,
	}),
	LuaRaid("Arachir_The_Ancient_One"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("Arachir The Ancient One", Area(Position(6141, 848, 5), Position(6141, 848, 5)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Piraci"):Context({
		...
		waves = {
			Wave(10)
				...
				:Notification(-9, "Pirates have attacked Kongo!"),
			Wave(180)
				:Creature("Pirate Buccaneer", Area(Position(6976, 741, 5), Position(7064, 814, 6)), 40, false)
				:Creature("Pirate Marauder", Area(Position(6976, 741, 5), Position(7064, 814, 6)), 40, false)
				:Creature("Pirate Cutthroat", Area(Position(6976, 741, 5), Position(7064, 814, 6)), 40, false)
				...
				:Creature("Smuggler", Area(Position(6976, 741, 5), Position(7064, 814, 6)), 25, false)
				:Notification(-10, "Pirates are sending support!"),
			Wave(360)
				:Creature("Pirate Buccaneer", Area(Position(6976, 741, 5), Position(7064, 814, 6)), 40, false)
				:Creature("Pirate Marauder", Area(Position(6976, 741, 5), Position(7064, 814, 6)), 40, false)
				:Creature("Pirate Cutthroat", Area(Position(6976, 741, 5), Position(7064, 814, 6)), 40, false)
				...
				:Notification(-10, "Pirates have sent additional reinforcements!"),
		},
		cooldown = 43200,
		minPlayersOnline = 5,
	}),
	LuaRaid("Minotaury"):Context({
		...
		waves = {
			Wave(10)
				...
				:Notification(-9, "A group of minotaurs has left their camp."),
			Wave(120):Creature("Minotaur", Area(Position(5891, 1411, 7), Position(5947, 1460, 7)), 38, true):Creature("Minotaur Guard", Area(Position(5891, 1411, 7), Position(5947, 1460, 7)), 38, true):Creature("Minotaur Archer", Area(Position(5891, 1411, 7), Position(5947, 1460, 7)), 38, true):Creature("Minotaur Mage", Area(Position(5891, 1411, 7), Position(5947, 1460, 7)), 15, true),
			Wave(185)
				...
				:Notification(-65, "Minotaurs are approaching the city!")
				:Notification(-5, "Minotaurs are attacking the city walls!"),
			Wave(245)
				...
				:Notification(-5, "The attack will likely cease if their general falls!"),
		},
		cooldown = 43200,
		minPlayersOnline = 5,
	}),
	LuaRaid("Kroliki"):Context({
		perDay = 0.288,
		waves = {
			Wave(10):Creature("Silver Rabbit", Area(Position(5801, 1475, 7), Position(5988, 1598, 7)), 55, false):Notification(-9, "Holiday bunnies have swarmed the entire city!"),
			Wave(120):Creature("Silver Rabbit", Area(Position(5801, 1475, 7), Position(5988, 1598, 7)), 65, false),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Zomba"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("Lion", Area(Position(6603, 1233, 7), Position(6672, 1302, 7)), 35, true):Creature("Zomba", Area(Position(6603, 1233, 7), Position(6672, 1302, 7)), 1, true),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Jaglak"):Context({
		perDay = 0.0144,
		waves = {
			Wave(600):Creature("Jaglak", Area(Position(5849, 1716, 7), Position(5849, 1716, 7)), 1, false):Notification(-599, "Cyclopes have ordered an extraordinary amount of cereal, perhaps preparing for a visit!"):Notification(-300, "Information about visit to the one-eyed by The Jaglak has been confirmed!"),
		},
		cooldown = 43200,
	...
	LuaRaid("Malpy"):Context({
		...
		waves = {
			Wave(10)
				...
				:Notification(-9, "An increased number of monkeys has been noticed below the Kongo settlement!"),
			Wave(180)
			...
			Wave(320)
				...
				:Creature("Merlkin", Area(Position(6976, 749, 5), Position(7065, 816, 6)), 50, false)
				:Creature("Hairman the Huge", Area(Position(6976, 749, 5), Position(7065, 816, 6)), 1, true)
				:Notification(-140, "Monkeys of focus, commitment, and sheer will are trying to rob Kongo again!"),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Dragonling2"):Context({
		perDay = 0.504,
		waves = {
			Wave(1):Creature("Dragonling", Area(Position(5614, 1409, 12), Position(5711, 1494, 12)), 6, true),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	...
	LuaRaid("Crystalwolves"):Context({
		perDay = 0.72,
		waves = {
			Wave(1):Creature("Crystal Wolf", Area(Position(6379, 1844, 7), Position(6474, 1875, 7)), 8, true),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	...
	LuaRaid("Acolyte_of_Darkness"):Context({
		perDay = 0.648,
		waves = {
			Wave(10):Creature("Acolyte of Darkness", Area(Position(7580, 1795, 11), Position(7580, 1795, 11)), 1, false),
		},
		cooldown = 10800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Grand_Mother_Foulscale2"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Grand Mother Foulscale", Area(Position(6671, 591, 6), Position(6671, 591, 6)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Necropharus3"):Context({
		perDay = 0.3168,
		waves = {
			Wave(10):Creature("Necropharus", Area(Position(6709, 1304, 12), Position(6709, 1304, 12)), 1, false),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Ocyakao"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Ocyakao", Area(Position(6496, 1827, 7), Position(6496, 1827, 7)), 1, false),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Mole"):Context({
		perDay = 2.16,
		waves = {
			Wave(10):Creature("Mole", Area(Position(5915, 1825, 8), Position(5915, 1825, 8)), 1, false):Creature("Mole", Area(Position(5917, 1813, 8), Position(5917, 1813, 8)), 1, false):Creature("Mole", Area(Position(5926, 1815, 8), Position(5926, 1815, 8)), 1, false),
		},
		cooldown = 7200,
		minPlayersOnline = 0,
	}),
	LuaRaid("Smuggler_baron_silvertoe"):Context({
		perDay = 0.864,
		waves = {
			Wave(10):Creature("Smuggler Baron Silvertoe", Area(Position(6054, 1400, 7), Position(6054, 1400, 7)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	...
	LuaRaid("The_Many"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("The Many", Area(Position(6737, 637, 5), Position(6737, 637, 5)), 1, false),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Ferumbras"):Context({
		perDay = 0.1584,
		waves = {
			Wave(720):Creature("Ferumbras", Area(Position(6112, 1324, 14), Position(6112, 1324, 14)), 1, true):Notification(-719, "Demonic shrieks emanate from the underground near the wizards' village."):Notification(-360, "Wizards in their underground academy are performing a summoning ceremony for their former Master."),
		},
		cooldown = 144000,
		minPlayersOnline = 5,
	}),
	LuaRaid("Rottie"):Context({
		perDay = 1.152,
		waves = {
			Wave(10):Creature("Rottie The Rotworm", Area(Position(5992, 1550, 9), Position(5992, 1550, 9)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Tiquandas_Revenge"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("Tiquandas Revenge", Area(Position(6708, 590, 7), Position(6708, 590, 7)), 1, true),
		},
		cooldown = 57600,
		minPlayersOnline = 1,
	}),
	LuaRaid("The_Handmaiden"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("The Handmaiden", Area(Position(6087, 1844, 15), Position(6087, 1844, 15)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Orki"):Context({
		...
		waves = {
			Wave(10)
				...
				:Notification(-9, "Orcs are attacking the city from the south!"),
			Wave(240)
				...
				:Notification(-10, "Orcs have sent additional reinforcements!"),
			Wave(280)
	...
	LuaRaid("Wasp"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("Wasp", Area(Position(5969, 1498, 6), Position(6023, 1576, 7)), 100, false):Creature("Willi Wasp", Area(Position(5969, 1498, 6), Position(6023, 1576, 7)), 1, true):Notification(-9, "Enraged bees are buzzing in the east of the city!"),
			Wave(120):Creature("Wasp", Area(Position(5969, 1498, 6), Position(6023, 1576, 7)), 90, false):Creature("Willi Wasp", Area(Position(5969, 1498, 6), Position(6023, 1576, 7)), 1, true),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Tromphonyte"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("Tromphonyte", Area(Position(5962, 1164, 8), Position(5962, 1164, 8)), 1, false),
		},
		cooldown = 57600,
		minPlayersOnline = 1,
	}),
	LuaRaid("Ladybug"):Context({
		perDay = 2.304,
		waves = {
			Wave(10):Creature("Ladybug", Area(Position(6614, 783, 7), Position(6614, 783, 7)), 1, false):Creature("Ladybug", Area(Position(6625, 770, 7), Position(6625, 770, 7)), 1, false):Creature("Ladybug", Area(Position(6637, 784, 7), Position(6637, 784, 7)), 1, false),
		},
		cooldown = 7200,
		minPlayersOnline = 0,
	}),
	...
	LuaRaid("Manta_Ray"):Context({
		perDay = 2.304,
		waves = {
			Wave(10):Creature("Manta Ray", Area(Position(6491, 743, 10), Position(6491, 743, 10)), 1, false):Creature("Manta Ray", Area(Position(6471, 745, 10), Position(6471, 745, 10)), 1, false):Creature("Manta Ray", Area(Position(6485, 728, 10), Position(6485, 728, 10)), 1, false):Creature("Manta Ray", Area(Position(6451, 753, 10), Position(6451, 753, 10)), 1, false),
		},
		cooldown = 7200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Xenia"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Xenia", Area(Position(5708, 1510, 4), Position(5708, 1510, 4)), 1, false),
		},
		cooldown = 64800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Raty"):Context({
		perDay = 0.216,
		waves = {
			Wave(10):Creature("Rat", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 200, false):Creature("Cave Rat", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 200, false):Creature("Munster", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 1, false):Notification(-9, "A plague of rats is spreading through the city!"),
			Wave(230):Creature("Rat", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 200, false):Creature("Cave Rat", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 200, false):Notification(-10, "Rats are still emerging from the sewers!"),
			Wave(420):Creature("Rat", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 200, false):Creature("Cave Rat", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 200, false):Creature("Munster", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 1, false),
			Wave(600):Creature("Rat", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 200, false):Creature("Cave Rat", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 200, false):Creature("Munster", Area(Position(5801, 1500, 4), Position(5973, 1610, 8)), 1, false),
		},
		cooldown = 64800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Gaz_haragoth"):Context({
		perDay = 0.1584,
		waves = {
			Wave(10):Creature("gaz'haragoth", Area(Position(6136, 700, 12), Position(6136, 700, 12)), 1, true):Notification(-9, "Gaz'haragoth will shatter your dreams in a barrage of nightmares!"),
		},
		cooldown = 158400,
		minPlayersOnline = 5,
	}),
	LuaRaid("Fleshcrawler"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("Fleshcrawler", Area(Position(6572, 1248, 9), Position(6572, 1248, 9)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Barbaria"):Context({
		perDay = 0.4752,
		waves = {
			Wave(10):Creature("Barbaria", Area(Position(6471, 1764, 7), Position(6471, 1764, 7)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Grand_Mother_Foulscale"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Grand Mother Foulscale", Area(Position(5875, 1334, 4), Position(5875, 1334, 4)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Gochabaal"):Context({
		perDay = 0.2016,
		waves = {
			Wave(600):Creature("Demon", Area(Position(5865, 1327, 3), Position(5901, 1368, 4)), 6, true):Notification(-599, "Terrible wails are echoing from the depths of the volcano, north of Mirko Town."),
			Wave(1200):Creature("Demon", Area(Position(5865, 1327, 3), Position(5901, 1368, 4)), 7, true):Creature("Gochabaal", Area(Position(5875, 1332, 4), Position(5875, 1332, 4)), 1, true):Notification(-600, "Gochabaal is trying to return from the underworld! Demons have appeared on the volcano above Mirko Town."),
		},
		cooldown = 144000,
		minPlayersOnline = 5,
	}),
	LuaRaid("Grorlam"):Context({
		perDay = 0.648,
		waves = {
			Wave(10):Creature("Grorlam", Area(Position(6794, 1241, 9), Position(6794, 1241, 9)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Crustacea_Gigantica"):Context({
		perDay = 2.304,
		waves = {
			Wave(10):Creature("Crustacea Gigantica", Area(Position(6701, 1071, 9), Position(6701, 1071, 9)), 1, false):Creature("Crustacea Gigantica", Area(Position(6722, 1066, 9), Position(6722, 1066, 9)), 1, false):Creature("Crustacea Gigantica", Area(Position(6694, 1077, 8), Position(6694, 1077, 8)), 1, false),
		},
		cooldown = 7200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Barbarian"):Context({
		...
		waves = {
			Wave(120)
				...
				:Notification(-119, "Barbarians are gathering in their village. It seems they are preparing for something."),
			Wave(240)
	...
	LuaRaid("Demodras"):Context({
		perDay = 0.2592,
		waves = {
			Wave(10):Creature("Demodras", Area(Position(5846, 1342, 3), Position(5877, 1369, 3)), 1, true):Creature("Dragon Lord", Area(Position(5846, 1342, 3), Position(5877, 1369, 3)), 12, true),
		},
		cooldown = 64800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Grynch"):Context({
		perDay = 0.288,
		waves = {
			Wave(125):Creature("Grynch Clan Goblin", Area(Position(5793, 1480, 7), Position(5973, 1598, 7)), 200, true):Notification(-124, "Goblins are coming to rob the city!"):Notification(-5, "The goblins have come to rob the city!"),
			Wave(360):Creature("Grynch Clan Goblin", Area(Position(5793, 1480, 7), Position(5973, 1598, 7)), 220, true),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Demodras2"):Context({
		perDay = 0.2592,
		waves = {
			Wave(10):Creature("Demodras", Area(Position(6702, 1117, 8), Position(6727, 1140, 8)), 1, true):Creature("Dragon Lord", Area(Position(6702, 1117, 8), Position(6727, 1140, 8)), 12, true),
		},
		cooldown = 64800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Ekatrix"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Ekatrix", Area(Position(5698, 1510, 3), Position(5698, 1510, 3)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	...
	LuaRaid("Karakan"):Context({
		perDay = 0.216,
		waves = {
			Wave(10):Creature("Bug", Area(Position(5711, 1542, 7), Position(5801, 1616, 7)), 150, true):Notification(-9, "Vermin has once again scattered in the west of MirkoTown!"),
			Wave(125):Creature("Bug", Area(Position(5711, 1542, 7), Position(5801, 1616, 7)), 45, true):Notification(-5, "Toxic bugs are attacking the farms!"),
			Wave(245):Creature("Bug", Area(Position(5711, 1542, 7), Position(5801, 1616, 7)), 25, true):Creature("Karaczan", Area(Position(5711, 1542, 7), Position(5801, 1616, 7)), 7, true):Notification(-5, "Cockroaches are appearing around the farm!"),
		},
		cooldown = 43200,
		minPlayersOnline = 5,
	}),
	LuaRaid("Supply_3"):Context({
		perDay = 0.648,
		waves = {
			Wave(1):Creature("Supply Dragon", Area(Position(6484, 579, 7), Position(6966, 821, 7)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 0,
	}),
	LuaRaid("Black_sheep"):Context({
		perDay = 2.304,
		waves = {
			Wave(10):Creature("Black sheep", Area(Position(5534, 1593, 7), Position(5534, 1593, 7)), 1, false):Creature("Black sheep", Area(Position(5543, 1580, 7), Position(5543, 1580, 7)), 1, false):Creature("Black sheep", Area(Position(5538, 1586, 7), Position(5538, 1586, 7)), 1, false),
		},
		cooldown = 7200,
		minPlayersOnline = 0,
	}),
	LuaRaid("The_Old_Widow"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("The Old Widow", Area(Position(6826, 739, 9), Position(6826, 739, 9)), 1, false),
		},
		cooldown = 57600,
		minPlayersOnline = 1,
	}),
	LuaRaid("Hatebreeder"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("Hatebreeder", Area(Position(6609, 926, 9), Position(6609, 926, 9)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Tyrn2"):Context({
		perDay = 0.8,
		waves = {
			Wave(10):Creature("Tyrn", Area(Position(6363, 1253, 3), Position(6363, 1253, 3)), 1, false),
		},
		cooldown = 57600,
		minPlayersOnline = 1,
	}),
	LuaRaid("Man_in_the_Cave"):Context({
		perDay = 0.432,
		waves = {
			Wave(10):Creature("Man in the Cave", Area(Position(6531, 1778, 9), Position(6531, 1778, 9)), 1, false),
		},
		cooldown = 10800,
		minPlayersOnline = 1,
	}),
	LuaRaid("Mr_Punish"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("Mr. Punish", Area(Position(6065, 1809, 15), Position(6065, 1809, 15)), 1, true),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Massacre"):Context({
		perDay = 0.36,
		waves = {
			Wave(10):Creature("Massacre", Area(Position(6170, 1832, 15), Position(6170, 1832, 15)), 1, true),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Necropharus2"):Context({
		perDay = 0.3168,
		waves = {
			Wave(10):Creature("Necropharus", Area(Position(5698, 1446, 9), Position(5698, 1446, 9)), 1, false),
		},
		cooldown = 43200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Fernfang"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Fernfang", Area(Position(5730, 1522, 14), Position(5730, 1522, 14)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Supply_5"):Context({
		perDay = 0.648,
		waves = {
			Wave(1):Creature("Supply Dragon", Area(Position(6143, 823, 7), Position(6542, 1105, 7)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 0,
	}),
	LuaRaid("Snowman"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Animated Snowman", Area(Position(5793, 1480, 7), Position(5973, 1598, 7)), 20, true),
		},
		cooldown = 7200,
		minPlayersOnline = 1,
	}),
	LuaRaid("Bane_Bringer"):Context({
		perDay = 0.648,
		waves = {
			Wave(10):Creature("Bane Bringer", Area(Position(7599, 1693, 9), Position(7599, 1693, 9)), 1, false),
		},
		cooldown = 10800,
		minPlayersOnline = 1,
	}),
	...
	LuaRaid("Panda"):Context({
		perDay = 2.16,
		waves = {
			Wave(10):Creature("Panda", Area(Position(6597, 773, 7), Position(6597, 773, 7)), 1, false):Creature("Panda", Area(Position(6593, 771, 7), Position(6593, 771, 7)), 1, false):Creature("Panda", Area(Position(6593, 764, 6), Position(6593, 764, 6)), 1, false),
		},
		cooldown = 7200,
		minPlayersOnline = 0,
	}),
	LuaRaid("Pinata_1"):Context({
		perDay = 1.008,
		waves = {
			Wave(1):Creature("Pinata Dragon", Area(Position(5738, 1295, 7), Position(6114, 1952, 7)), 2, false),
		},
		cooldown = 14400,
		minPlayersOnline = 0,
	}),
	LuaRaid("Mad_Mage_and_Servants"):Context({
		...
		waves = {
			Wave(10)
				...
				:Notification(-9, "The Mad Mage has been sighted sneaking into his lair located in the deep underground on the east of Orshaawa."),
		},
		cooldown = 10800,
		minPlayersOnline = 1,
	}),
	LuaRaid("The_Evil_Eye"):Context({
		perDay = 0.7,
		waves = {
			Wave(10):Creature("The Evil Eye", Area(Position(5769, 1411, 9), Position(5769, 1411, 9)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Walker"):Context({
		perDay = 1.08,
		waves = {
			Wave(1):Creature("Walker", Area(Position(5728, 1160, 8), Position(5812, 1209, 8)), 6, true),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
	LuaRaid("Hide"):Context({
		perDay = 0.576,
		waves = {
			Wave(10):Creature("Hide", Area(Position(6826, 739, 9), Position(6826, 739, 9)), 1, false),
		},
		cooldown = 14400,
		minPlayersOnline = 1,
	}),
