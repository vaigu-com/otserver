...
dofile(CORE_DIRECTORY .. "/libs/functions/encounter_data_registry.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/encounter_instance_registry.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/encounter.lua")
...
dofile(CORE_DIRECTORY .. "/libs/functions/questlog.lua")
