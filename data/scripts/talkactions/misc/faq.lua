...
function talkaction.onSay(player, words, param)
	local text = "Najczesciej zadawane pytania:"
		...
		.. "\n"
		.. "\n 6. Jak ustawic autoloot (quickloot)?"
	...
	local engtext = "Frequently asked questions:"
		...
		.. "\n"
		.. "\n 3. Where can I train?"
		.. "\n - Offline training statues are in first building south west of Mirkotown temple"
		.. "\n - Exercise training dummy is in depot"
		.. "\n"
		...
		.. "\n"
		.. "\n 6. How to use autoloot (quickloot)?"
