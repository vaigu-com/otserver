local config = {
	{ from = 1, to = 544, itemId = 48114 },
	{ from = 545, to = 944, itemId = 16108 },
	{ from = 945, to = 3189, itemId = 3041 },
	{ from = 3190, to = 3825, itemId = 16097 },
	{ from = 3826, to = 4725, itemId = 12669 },
	{ from = 4726, to = 5825, itemId = 16120, count = 5 },
	{ from = 5826, to = 6225, itemId = 9042 },
	...
	for i = 1, #config do
		...
		if chance >= randomItem.from and chance <= randomItem.to then
			if toPosition.x == CONTAINER_POSITION then
				player:AddCustomItem({ id = randomItem.itemId, count = randomItem.count or 1 })
			else
