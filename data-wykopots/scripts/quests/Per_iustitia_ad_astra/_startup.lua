local startupStatic = {
	...
	},
	{
		...
		rewards = { PER_IUSTITIA_AD_ASTRA_KEY_ITEMS["ENGINE_BLUEPRINT"] },
		requiredState = {
...
local startupGanymede = {
	{
		...
		rewards = { PER_IUSTITIA_AD_ASTRA_KEY_ITEMS["SWAGIER_CRATE"] },
...
local startupHugoTarPlanet = {
	{
		...
		rewards = { PER_IUSTITIA_AD_ASTRA_KEY_ITEMS["OFFICER_ID"] },
...
local startupItemsHugoBeachPlanet = {
	{
		...
		rewards = { PER_IUSTITIA_AD_ASTRA_KEY_ITEMS["HUGO_RECIPE"] },
	...
	{ pos = { 16, -78, 2 }, id = 2472, aid = Storage.PerIustitiaAdAstra.MysteriousChest },
	{
		...
		rewards = { PER_IUSTITIA_AD_ASTRA_KEY_ITEMS["LECINA_HAMMER"] },
	},
