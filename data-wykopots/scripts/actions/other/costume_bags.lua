...
function costumeBags.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	player:sendTextMessage(MESSAGE_STATUS, "You will stay transformed into a monster for 1 hour!")
	doSetMonsterOutfit(player, monsterNames[math.random(#monsterNames)], 3600 * 1000)
