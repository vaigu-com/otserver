...
function enchanting.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if table.contains({ 6230, 6231 }, toPosition.x) and toPosition.y == 1006 and toPosition.z == 10 and player:getStorageValue(Storage.ElementalSphere.QuestLine) > 0 then
...
enchanting:id(675, 676, 677, 678, 3030, 3029, 3032, 3033)
enchanting:register()
