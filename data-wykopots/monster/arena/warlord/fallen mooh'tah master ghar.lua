...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 60, attack = 150, condition = { type = CONDITION_POISON, totalDamage = 360, interval = 4000 } },
	{ name = "combat", interval = 6000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -80, maxDamage = -300, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false },
