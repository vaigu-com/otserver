...
monster.attacks = {
	...
	{ name = "combat", interval = 7500, chance = 100, type = COMBAT_PHYSICALDAMAGE, minDamage = -100, maxDamage = -250, shootEffect = CONST_ANI_LARGEROCK, effect = CONST_ME_STUN, target = false },
}
