...
monster.summon = {
	maxSummons = 2,
	summons = {
		{ name = "Ghoul", chance = 20, interval = 2000, count = 3 },
	},
}
...
monster.attacks = {
	-- poison
	{ name = "condition", type = CONDITION_POISON, interval = 2000, chance = 100, target = false },
	...
	{ name = "speed", interval = 3500, chance = 35, range = 5, radius = 1, effect = CONST_ME_MAGIC_RED, target = true, speedChange = -400, duration = 10000 },
