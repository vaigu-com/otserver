...
monster.attacks = {
	...
	{ name = "firefield", interval = 2000, chance = 10, range = 7, radius = 3, target = false },
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -60, maxDamage = -430, range = 7, radius = 3, effect = CONST_ME_HITBYFIRE, target = false },
