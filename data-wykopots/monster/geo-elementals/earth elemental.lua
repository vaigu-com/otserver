...
monster.loot = {
	...
	{id = 10305, chance = 20460},
	{id = 774, chance = 20160, maxCount = 30},
	{id = 3147, chance = 10000},
	{id = 237, chance = 1910},
	{id = 10422, chance = 570},
	{id = 12600, chance = 470},
	{id = 8894, chance = 350},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -130, range = 7, radius = 2, shootEffect = CONST_ANI_LARGEROCK, effect = CONST_ME_POFF, target = true},
	-- poison
...
monster.defenses = {
	defense = 45,
	armor = 45,
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_HEALING, minDamage = 40, maxDamage = 70, effect = CONST_ME_MAGIC_BLUE, target = false}
}
