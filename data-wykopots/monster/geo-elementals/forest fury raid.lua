local mType = Game.createMonsterType("Forest Fury Raid")
local monster = {}
...
monster.loot = {
	{ name = "silver raid token", chance = 1500 },
	{ name = "gold coin", chance = 87250, maxCount = 54 },
	{ id = 3446, chance = 48270, maxCount = 15 },
	{ id = 3577, chance = 24930 },
	{ id = 7363, chance = 14900, maxCount = 5 },
	{ id = 18995, chance = 13210 },
	{ id = 18994, chance = 7930 },
	{ id = 3349, chance = 2750 },
	{ id = 9057, chance = 470 },
	{ id = 7438, chance = 230 },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 1500, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -100, range = 7, radius = 4, shootEffect = CONST_ANI_HUNTINGSPEAR, effect = CONST_ME_MAGIC_GREEN, target = true },
