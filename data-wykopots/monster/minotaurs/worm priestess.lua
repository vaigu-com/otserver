...
monster.loot = {
	{name = "gold coin", chance = 100000, minCount = 2, maxCount = 150},
	{name = "platinum coin", chance = 41130, maxCount = 3},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 18, type = COMBAT_LIFEDRAIN, minDamage = -50, maxDamage = -130, range = 7, shootEffect = CONST_ANI_SMALLSTONE, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -165, range = 4, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_POISONAREA, target = false},
	{name ="worm priestess paralyze", interval = 2000, chance = 10, target = false},
...
monster.defenses = {
	defense = 38,
	armor = 38,
	{name ="combat", interval = 2000, chance = 8, type = COMBAT_HEALING, minDamage = 0, maxDamage = 150, effect = CONST_ME_MAGIC_RED, target = false},
