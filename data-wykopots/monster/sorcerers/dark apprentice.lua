...
monster.loot = {
	...
	{ id = 3147, chance = 9025, maxCount = 3 },
	{ id = 268, chance = 2980 },
	{ id = 5934, chance = 12100 },
	{ id = 3075, chance = 2080 },
	{ id = 266, chance = 2900 },
	{ id = 3072, chance = 170 },
	{ id = 12308, chance = 10 },
...
monster.defenses = {
	defense = 16,
	armor = 16,
	{ name = "combat", interval = 2000, chance = 13, type = COMBAT_HEALING, minDamage = 30, maxDamage = 40, effect = CONST_ME_MAGIC_GREEN, target = false },
