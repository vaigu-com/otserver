...
monster.loot = {
	{ name = "gold coin", chance = 93300, maxCount = 149 },
	{ id = 237, chance = 9810 },
	{ id = 9685, chance = 9900 },
	{ name = "platinum coin", chance = 10070 },
	{ id = 3070, chance = 4960 },
	{ id = 236, chance = 4910 },
	{ id = 11449, chance = 4890 },
	{ id = 3010, chance = 880 },
	{ id = 8045, chance = 1040 },
	{ id = 3028, chance = 950, maxCount = 2 },
	{ id = 8895, chance = 950 },
	{ id = 8923, chance = 1030 },
	{ id = 3079, chance = 200 },
	{ id = 649, chance = 230 },
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 66, attack = 50 },
	{ name = "combat", interval = 3000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -60, maxDamage = -130, range = 1, effect = CONST_ME_MAGIC_RED, target = true },
	{ name = "combat", interval = 2000, chance = 11, type = COMBAT_DEATHDAMAGE, minDamage = -60, maxDamage = -150, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true },
...
monster.defenses = {
	defense = 55,
	armor = 55,
	{ name = "combat", interval = 2000, chance = 12, type = COMBAT_HEALING, minDamage = 40, maxDamage = 80, effect = CONST_ME_MAGIC_BLUE, target = false },
}
