...
monster.loot = {
	{name = "gold coin", chance = 89910, maxCount = 60},
	{id = 9685, chance = 8000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -50, maxDamage = -120, range = 1, effect = CONST_ME_MAGIC_RED, target = true},
	{name ="vampire paralyze", interval = 2000, chance = 11, range = 7, target = false}
}
...
monster.defenses = {
	...
	{name ="speed", interval = 2000, chance = 10, speedChange = 330, effect = CONST_ME_MAGIC_RED, target = false, duration = 9000},
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_HEALING, minDamage = 15, maxDamage = 25, target = false}
}
