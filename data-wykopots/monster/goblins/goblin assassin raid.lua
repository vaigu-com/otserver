local mType = Game.createMonsterType("Goblin Assassin Raid")
local monster = {}
...
monster.loot = {
	...
	{ id = 3267, chance = 17000 },
	{ id = 3361, chance = 7240 },
	{ id = 3462, chance = 9800 },
	{ id = 1781, chance = 9900, maxCount = 3 },
	{ id = 3120, chance = 6610 },
	{ id = 3355, chance = 13000 },
...
monster.defenses = {
	defense = 5,
	armor = 5,
	{ name = "invisible", interval = 2000, chance = 8, duration = 5000, effect = CONST_ME_MAGIC_BLUE },
	{ name = "speed", interval = 2000, chance = 10, speedChange = 145, effect = CONST_ME_MAGIC_RED, target = false, duration = 3000 },
}
