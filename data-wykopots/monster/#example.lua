...
monster.summon = {
	maxSummons = 2,
	summons = {
		{ name = "demon", chance = 15, interval = 2000, count = 2 },
	},
}
...
monster.loot = {
	...
	{ name = "bag", chance = 60000, child = {
		{ name = "platin coin", chance = 60000, maxCount = 100 },
		{ name = "crystal coin", chance = 60000, maxCount = 100 },
	} },
}
