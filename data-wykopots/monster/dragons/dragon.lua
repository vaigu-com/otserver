...
monster.loot = {
	{name = "gold coin", chance = 90500, maxCount = 105},
	{id = 11457, chance = 10500},
	{id = 3583, chance = 65500, maxCount = 3},
	{id = 3409, chance = 15000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 14, type = COMBAT_FIREDAMAGE, minDamage = -60, maxDamage = -110, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
