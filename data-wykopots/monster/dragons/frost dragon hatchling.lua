...
monster.attacks = {
	...
	{name ="speed", interval = 2000, chance = 10, speedChange = -600, radius = 4, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEAREA, target = true, duration = 12000}
}
