...
monster.attacks = {
	...
	{name ="combat", interval = 2500, chance = 17, type = COMBAT_FIREDAMAGE, minDamage = -70, maxDamage = -250, length = 8, spread = 0, effect = CONST_ME_FIREAREA, target = false}
}
