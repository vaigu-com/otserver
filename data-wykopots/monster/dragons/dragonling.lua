...
monster.loot = {
	...
	{id = 237, chance = 16900, maxCount = 2},
	{id = 236, chance = 24480, maxCount = 2},
	{id = 16131, chance = 12410}
}
...
monster.attacks = {
	...
	{name ="speed", interval = 2000, chance = 10, speedChange = -700, radius = 1, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_STUN, target = true, duration = 16000}
}
