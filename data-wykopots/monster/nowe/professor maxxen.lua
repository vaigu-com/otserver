...
monster.summon = {
	maxSummons = 8,
	summons = {
		{ name = "walker", chance = 10, interval = 2000, count = 5 },
		{ name = "glooth trasher", chance = 10, interval = 2000, count = 5 },
		{ name = "glooth smasher", chance = 10, interval = 2000, count = 5 },
		{ name = "glooth slasher", chance = 10, interval = 2000, count = 5 },
	},
}
