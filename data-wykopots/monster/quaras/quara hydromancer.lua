...
monster.loot = {
	{ name = "gold coin", chance = 89000, maxCount = 110 },
	{ id = 11488, chance = 14730 },
	{ id = 3581, chance = 4845, maxCount = 5 },
	{ id = 3027, chance = 2950 },
	{ id = 3026, chance = 5250 },
	{ id = 3032, chance = 5111, maxCount = 2 },
	{ id = 3073, chance = 1000 },
...
monster.attacks = {
	...
	{ name = "speed", interval = 2000, chance = 15, speedChange = -700, range = 7, effect = CONST_ME_MAGIC_RED, target = false, duration = 15000 },
}
