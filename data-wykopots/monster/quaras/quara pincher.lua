...
monster.loot = {
	...
	{ id = 11490, chance = 14885 },
	{ id = 3030, chance = 7761, maxCount = 2 },
	{ id = 3269, chance = 6861 },
	{ id = 3581, chance = 5245, maxCount = 5 },
	{ id = 5895, chance = 1600 },
	{ id = 3369, chance = 1590 },
...
monster.attacks = {
	...
	{ name = "speed", interval = 2000, chance = 15, speedChange = -600, range = 1, effect = CONST_ME_MAGIC_RED, target = false, duration = 3000 },
}
