local mType = Game.createMonsterType("Quara Predator slow")
local monster = {}
...
monster.defenses = {
	defense = 40,
	armor = 40,
	{name ="speed", interval = 2000, chance = 15, speedChange = 370, effect = CONST_ME_MAGIC_GREEN, target = false, duration = 5000},
