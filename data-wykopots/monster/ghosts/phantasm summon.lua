...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 84, attack = 10 },
	{ name = "combat", interval = 2000, chance = 7, type = COMBAT_DEATHDAMAGE, minDamage = -34, maxDamage = -60, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false },
...
monster.defenses = {
	defense = 0,
	armor = 0,
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_HEALING, minDamage = 22, maxDamage = 44, effect = CONST_ME_MAGIC_BLUE, target = false },
