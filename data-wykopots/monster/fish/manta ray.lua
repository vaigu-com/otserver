...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 34, attack = 45, condition = { type = CONDITION_POISON, totalDamage = 120, interval = 4000 } },
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_ENERGYDAMAGE, length = 4, spread = 0, effect = CONST_ME_ENERGYHIT, target = false },
}
