local mType = Game.createMonsterType("Dread Intruder Summon")
local monster = {}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -190, range = 6, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_PURPLEENERGY, target = true },
	-- energy damage
	{ name = "condition", type = CONDITION_ENERGY, interval = 1000, chance = 15, radius = 4, effect = CONST_ME_YELLOWENERGY, target = false },
