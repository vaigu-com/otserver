...
monster.loot = {
	{ name = "gold coin", chance = 50000, maxCount = 188 },
	{ id = 237, chance = 13450 },
	{ id = 287, chance = 9550, maxCount = 15 },
	{ name = "great mana potion", chance = 7550 },
	{ id = 8895, chance = 7300 },
	{ id = 3033, chance = 3570, maxCount = 3 },
	{ id = 8092, chance = 730 },
	{ id = 816, chance = 730 },
	{ id = 8073, chance = 360 },
	{ id = 822, chance = 150 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -105, maxDamage = -410, range = 7, radius = 2, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -205, range = 7, shootEffect = CONST_ANI_ENERGYBALL, effect = CONST_ME_ENERGYHIT, target = true },
