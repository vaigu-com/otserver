...
monster.loot = {
	...
	{ id = 3447, chance = 7570, maxCount = 5 },
	{ id = 266, chance = 3480 },
	{ id = 268, chance = 3420 },
	{ id = 17458, chance = 12830 },
	{ id = 17463, chance = 8610 },
	{ id = 3003, chance = 4300 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 5, attack = 5, condition = { type = CONDITION_POISON, totalDamage = 10, interval = 4000 } },
