local mType = Game.createMonsterType("Wasp Raid")
local monster = {}
...
monster.attacks = {
	{name ="melee", interval = 1500, chance = 100, skill = 30, attack = 10, condition = {type = CONDITION_POISON, totalDamage = 20, interval = 4000}}
}
