...
monster.loot = {
	...
	{ id = 3030, chance = 2700, maxCount = 2 },
	{ id = 3492, chance = 65000, maxCount = 7 },
	{ id = 3577, chance = 51060, maxCount = 3 },
	{ id = 266, chance = 19840 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 30, attack = 56, condition = { type = CONDITION_POISON, totalDamage = 10, interval = 4000 } },
	-- poison
...
monster.defenses = {
	defense = 19,
	armor = 15,
	{ name = "speed", interval = 2000, chance = 10, speedChange = 1218, effect = CONST_ME_POFF, target = false, duration = 2000 },
}
