local mType = Game.createMonsterType("Giant Spider Raid")
local monster = {}
...
monster.loot = {
	{name = "silver raid token", chance = 2000},
	{name = "gold coin", chance = 99000, maxCount = 197},
	{id = 3448, chance = 12500, maxCount = 12},
	{id = 3557, chance = 8040},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 50, attack = 100, condition = {type = CONDITION_POISON, totalDamage = 150, interval = 4000}},
	{name ="poisonfield", interval = 2000, chance = 17, range = 7, radius = 1, shootEffect = CONST_ANI_POISON, target = true},
