local mType = Game.createMonsterType("Tarantula Raid")
local monster = {}
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 30, attack = 45, condition = {type = CONDITION_POISON, totalDamage = 40, interval = 4000}},
