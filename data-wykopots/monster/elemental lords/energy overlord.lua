...
monster.loot = {
	{ name = "gold coin", chance = 73700, maxCount = 75 },
	{ id = 948, chance = 100000 },
	{ name = "platinum coin", chance = 41000, maxCount = 2 },
	{ id = 8051, chance = 780 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 40, attack = 80 },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = 0, maxDamage = -800, length = 8, spread = 0, effect = CONST_ME_ENERGYAREA, target = false },
	...
	{ name = "cliff strider electrify", interval = 2000, chance = 11, range = 7, target = false },
	{ name = "energy overlord paralyze", interval = 2000, chance = 14, target = false },
}
