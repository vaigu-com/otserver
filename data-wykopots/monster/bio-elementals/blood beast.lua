...
monster.loot = {
	{id = 21195, chance = 16010},
	{id = 9640, chance = 5080},
	{id = 21146, chance = 3720},
	{name = "gold coin", chance = 100000, maxCount = 150},
	{id = 21194, chance = 20040},
	{id = 236, chance = 7710},
	{id = 7366, chance = 8290, maxCount = 5},
	{id = 21183, chance = 850},
	{id = 21179, chance = 810},
	{id = 21178, chance = 810},
	{id = 21180, chance = 1050},
	{id = 21158, chance = 780}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -250, condition = {type = CONDITION_POISON, totalDamage = 260, interval = 4000}},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -40, maxDamage = -130, range = 5, shootEffect = CONST_ANI_GREENSTAR, effect = CONST_ME_POISONAREA, target = true},
	-- poison
...
monster.defenses = {
	...
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_HEALING, minDamage = 80, maxDamage = 120, effect = CONST_ME_MAGIC_BLUE, target = false}
}
