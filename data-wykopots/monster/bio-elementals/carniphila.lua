...
monster.loot = {
	...
	{id = 3728, chance = 7692},
	{id = 10300, chance = 4166},
	{id = 3740, chance = 880},
	{id = 3597, chance = 890},
	{id = 647, chance = 490},
	{id = 3738, chance = 446, maxCount = 2},
	{id = 12311, chance = 170}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 30, attack = 50, condition = {type = CONDITION_POISON, totalDamage = 100, interval = 4000}},
	...
	{name ="carniphila paralyze", interval = 2000, chance = 26, range = 7, target = false},
