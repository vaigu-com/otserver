...
-- maxSummons = 2,
-- summons = {
-- { name = "hardened usurper archer", chance = 5, interval = 2000, count = 1 },
-- { name = "hardened usurper warlock", chance = 5, interval = 2000, count = 1 },
-- { name = "hardened usurper knight", chance = 5, interval = 2000, count = 1 }
-- }
-- }
