...
monster.race = "blood"
monster.corpse = 29334
monster.speed = 130

-- monster.summon = {
-- maxSummons = 3,
-- summons = {
-- { name = "preceptor lazare", chance = 5, interval = 8000, count = 1 },
-- { name = "grand commander soeren", chance = 5, interval = 8000, count = 1 },
-- { name = "grand chaplain gaunder", chance = 5, interval = 8000, count = 1 }
-- }
-- }
