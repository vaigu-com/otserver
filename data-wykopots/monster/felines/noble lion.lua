...
monster.loot = {
	...
	{ id = 3577, chance = 28000, maxCount = 4 },
	{ name = "ham", chance = 26000, maxCount = 2 },
...
monster.defenses = {
	defense = 27,
	armor = 27,
	{ name = "speed", interval = 2000, chance = 15, speedChange = 230, effect = CONST_ME_MAGIC_RED, target = false, duration = 5000 },
}
