...
monster.loot = {
	...
	{ id = 14085, chance = 20000 },
	{ id = 14008, chance = 25000 },
	{ id = 14009, chance = 20000 },
	{ id = 3578, chance = 9090, maxCount = 2 },
	{ id = 3029, chance = 8440, maxCount = 3 },
	{ id = 12730, chance = 9380 },
	{ id = 3052, chance = 3300 },
	{ id = 13987, chance = 3400 },
	{ id = 5895, chance = 1450 },
	{ id = 13990, chance = 1330 },
	{ id = 14247, chance = 39 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -190 },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -150, maxDamage = -400, length = 10, spread = 3, effect = CONST_ME_ICETORNADO, target = false },
