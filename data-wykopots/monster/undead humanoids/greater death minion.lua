...
monster.loot = {
	...
	{ id = 3492, chance = 19000, maxCount = 3 },
	{ id = 11466, chance = 11690 },
	{ id = 9649, chance = 10000 },
	{ id = 3046, chance = 5800 },
	{ id = 3045, chance = 5000 },
	{ id = 3017, chance = 4000 },
	{ id = 3007, chance = 1500 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -30, maxDamage = -40, range = 1, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_SMALLCLOUDS, target = true },
