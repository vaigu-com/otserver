...
monster.loot = {
	{ name = "gold coin", chance = 62870, maxCount = 62 },
	{ id = 12483, chance = 2840 }, -- pharaoh banner
	{ id = 3117, chance = 9000 }, -- broken flask
	{ name = "black pearl", chance = 1280 },
	{ name = "little bowl of myrrh", chance = 13550 },
	{ name = "single human eye", chance = 9550 },
	{ name = "green gem", chance = 1970 },
	{ name = "green bandage", chance = 10000 },
	{ name = "mini mummy", chance = 12 },
	{ name = "scarab coin", chance = 9080, maxCount = 3 },
	{ name = "poison dagger", chance = 560 },
}
...
monster.attacks = {
	...
	{ name = "outfit", interval = 2000, chance = 3, range = 7, target = true, duration = 3000, outfitMonster = "mummy" },
}

monster.defenses = {
	defense = 40,
	armor = 40,
	{ name = "combat", interval = 2000, chance = 8, type = COMBAT_HEALING, minDamage = 150, maxDamage = 200, effect = CONST_ME_MAGIC_BLUE, target = false },
}
