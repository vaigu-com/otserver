...
monster.loot = {
	{name = "gold coin", chance = 99000, maxCount = 199},
	{id = 3451, chance = 50000},
	{name = "flask of demonic blood", chance = 25000, maxCount = 2},
	{id = 3147, chance = 16666, maxCount = 2},
	...
	{id = 3033, chance = 2250, maxCount = 3},
	{id = 3049, chance = 2702},
	{id = 3275, chance = 1994},
	{id = 6299, chance = 120},
	{id = 826, chance = 250},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 70, attack = 60, condition = {type = CONDITION_POISON, totalDamage = 200, interval = 4000}},
	...
	{name ="diabolic imp skill reducer", interval = 2000, chance = 8, range = 7, target = false}
}

monster.defenses = {
	defense = 29,
	armor = 29,
	{name ="combat", interval = 2000, chance = 7, type = COMBAT_HEALING, minDamage = 650, maxDamage = 800, effect = CONST_ME_MAGIC_BLUE, target = false},
