...
monster.loot = {
	{ name = "small sapphire", chance = 80000, maxCount = 10 },
	{ name = "platinum coin", chance = 100000, minCount = 5, maxCount = 15 },
	{ name = "gold Ingot", chance = 80000, maxCount = 2 },
	{ name = "broccoli", chance = 50000, maxCount = 5 },
	{ name = "small Diamond", chance = 25000, maxCount = 10 },
	{ name = "blue Gem", chance = 5000 },
	{ id = 3039, chance = 5000 },
	{ name = "deepling Ceremonial Dagger", chance = 4000 },
	{ name = "deepling Fork", chance = 1000 },
	{ name = "true Book of Death", chance = 100000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -500 },
	{ name = "combat", interval = 2000, chance = 14, type = COMBAT_HOLYDAMAGE, minDamage = -100, maxDamage = -700, length = 8, spread = 0, effect = CONST_ME_MORTAREA, target = false },
	...
	{ name = "combat", interval = 2000, chance = 14, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -840, length = 8, spread = 0, effect = CONST_ME_HITBYFIRE, target = false },
	{ name = "combat", interval = 2000, chance = 14, type = COMBAT_HOLYDAMAGE, minDamage = -300, maxDamage = -700, length = 8, spread = 0, effect = CONST_ME_HOLYAREA, target = false },
