...
monster.loot = {
	...
	{ id = 3428, chance = 2035 },
	{ id = 10406, chance = 7925 },
	{ id = 7643, chance = 4020 },
	{ id = 3577, chance = 30300 },
	{ id = 10386, chance = 2000 },
	{ id = 3006, chance = 220 },
	{ id = 3030, chance = 1525, maxCount = 5 },
	{ id = 10388, chance = 810 },
	{ id = 10387, chance = 910 },
	{ id = 10384, chance = 820 },
	{ id = 10404, chance = 12040 },
	{ id = 10405, chance = 7040 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -250 },
	{ name = "combat", interval = 2000, chance = 12, type = COMBAT_FIREDAMAGE, minDamage = -120, maxDamage = -480, length = 4, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false },
}

monster.defenses = {
	defense = 55,
	armor = 55,
	{ name = "combat", interval = 2000, chance = 12, type = COMBAT_HEALING, minDamage = 150, maxDamage = 300, effect = CONST_ME_MAGIC_BLUE, target = false },
}
