...
monster.summon = {
	maxSummons = 4,
	summons = {
		{ name = "Fire Elemental", chance = 100, interval = 2000, count = 4 },
	},
}
...
monster.loot = {
	...
	{ id = 3030, chance = 7000, maxCount = 3 },
	{ id = 3052, chance = 1500 },
	...
	{ id = 3024, chance = 500 },
	{ id = 3439, chance = 300 },
	{ id = 3240, chance = 100000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 70, attack = 100, condition = { type = CONDITION_POISON, totalDamage = 65, interval = 4000 } },
