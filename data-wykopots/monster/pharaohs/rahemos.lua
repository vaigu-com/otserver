...
monster.loot = {
	...
	{ id = 3033, chance = 7000, maxCount = 3 },
	{ id = 3098, chance = 7000 },
	...
	{ id = 3068, chance = 500 },
	{ id = 3335, chance = 200 },
	{ id = 3235, chance = 100000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 90, attack = 150, condition = { type = CONDITION_POISON, totalDamage = 65, interval = 4000 } },
