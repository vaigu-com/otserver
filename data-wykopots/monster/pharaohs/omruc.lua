...
monster.loot = {
	...
	{ id = 3331, chance = 10000, maxCount = 2 },
	{ id = 3447, chance = 10000, maxCount = 21 },
	{ id = 3448, chance = 10000, maxCount = 20 },
	{ id = 3449, chance = 10000, maxCount = 15 },
	{ id = 7365, chance = 10000, maxCount = 2 },
	{ id = 3450, chance = 10000, maxCount = 3 },
	{ id = 3028, chance = 7000, maxCount = 3 },
	{ name = "great health potion", chance = 7000 },
	{ id = 3049, chance = 5000 },
	{ id = 3037, chance = 5000 },
	{ id = 3079, chance = 1500 },
	{ id = 3332, chance = 300 },
	{ id = 3239, chance = 100000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 30, attack = 60, condition = { type = CONDITION_POISON, totalDamage = 65, interval = 4000 } },
