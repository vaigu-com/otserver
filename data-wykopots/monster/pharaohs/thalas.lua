...
monster.summon = {
	maxSummons = 8,
	summons = {
		{ name = "Slime2", chance = 100, interval = 2000, count = 8 },
	},
}
...
monster.loot = {
	...
	{ name = "gold coin", chance = 50000, maxCount = 80 },
	{ id = 3032, chance = 7000, maxCount = 3 },
	{ id = 3299, chance = 7000 },
	{ id = 3053, chance = 7000 },
	{ id = 3049, chance = 1500 },
	...
	{ id = 3038, chance = 500 },
	{ id = 3339, chance = 200 },
	{ id = 3238, chance = 100000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, skill = 140, attack = 120 },
