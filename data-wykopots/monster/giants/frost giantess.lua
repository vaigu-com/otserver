...
monster.loot = {
	...
	{id = 3413, chance = 1490},
	{id = 7460, chance = 320},
	{id = 1781, chance = 10360, maxCount = 3},
	{id = 3093, chance = 70},
	{id = 3384, chance = 170},
	{id = 7290, chance = 100},
	{id = 268, chance = 1000}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -90, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false}
}
