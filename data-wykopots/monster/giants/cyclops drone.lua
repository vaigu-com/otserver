...
monster.loot = {
	...
	{ id = 3577, chance = 50430, maxCount = 2 },
	{ id = 3294, chance = 8000 },
	{ id = 3410, chance = 2000 },
	{ id = 3413, chance = 1600 },
	{ id = 3269, chance = 680 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -75, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false },
}
