...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 60, attack = 45, condition = {type = CONDITION_POISON, totalDamage = 100, interval = 4000}},
	...
	-- poison
	{name ="condition", type = CONDITION_POISON, interval = 2000, chance = 10, minDamage = -80, maxDamage = -100, length = 5, spread = 0, effect = CONST_ME_POISONAREA, target = false},
	{name ="speed", interval = 2000, chance = 7, speedChange = -500, range = 7, effect = CONST_ME_MAGIC_RED, target = true, duration = 30000},
