...
monster.loot = {
	...
	{ name = "platinum coin", chance = 36000, maxCount = 5 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 3000, chance = 17, type = COMBAT_LIFEDRAIN, minDamage = -400, maxDamage = -500, length = 8, spread = 0, effect = CONST_ME_MAGIC_RED, target = false },
