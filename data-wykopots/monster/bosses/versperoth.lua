...
monster.summon = {
	maxSummons = 7,
	summons = {
		{ name = "Minion of Vesperoth", chance = 16, interval = 2000, count = 7 },
	},
}
...
monster.attacks = {
	...
	{ name = "firefield", interval = 1200, chance = 30, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, target = false },
