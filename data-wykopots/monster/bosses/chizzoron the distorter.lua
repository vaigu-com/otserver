...
monster.loot = {
	{ name = "silver raid token", chance = 100000, minCount = 5, maxCount = 5 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = 0, maxDamage = -874, length = 8, spread = 3, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = false },
