...
monster.summon = {
	maxSummons = 4,
	summons = {
		{ name = "hellfire fighter", chance = 8, interval = 1000, count = 4 },
	},
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 1000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -1000, length = 8, spread = 0, effect = CONST_ME_EXPLOSIONHIT, target = false },
