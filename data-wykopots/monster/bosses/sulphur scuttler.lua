...
monster.loot = {
	...
	{ name = "platinum coin", chance = 98330, maxCount = 10 },
	{ name = "terra rod", chance = 65000 },
	{ name = "terra hood", chance = 20000 },
	{ name = "terra boots", chance = 20000 },
	{ name = "epee", chance = 12000 },
	--{id = 9640, chance = 50000}, -- slime
	--{id = 10305, chance = 75000}, -- lump earth
	--{id = 10315, chance = 96670}, -- sulphurous stone
	--{id = 11703, chance = 100000}, -- brimsotne shell
	--{id = 237, chance = 71670}, --
	--{id = 236, chance = 75000},
	--{id = 11702, chance = 100000}, -- 12658
	{ id = 3032, chance = 65000, maxCount = 6 }, -- kamyk
	{ id = 5904, chance = 81670 }, -- sulph
	{ id = 3049, chance = 56670 }, -- stealth
	{ id = 3055, chance = 20000 }, -- platinum
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = 0, maxDamage = -200, length = 6, spread = 0, effect = CONST_ME_HITBYPOISON, target = false },
