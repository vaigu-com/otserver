...
monster.summon = {
	maxSummons = 3,
	summons = {
		{ name = "Undead Gladiator", chance = 10, interval = 1000, count = 3 },
	},
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2800, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -400, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false },
	...
	{ name = "combat", interval = 2000, chance = 18, type = COMBAT_DEATHDAMAGE, minDamage = -165, maxDamage = -200, length = 7, spread = 0, target = false },
	{ name = "combat", interval = 2500, chance = 22, type = COMBAT_MANADRAIN, minDamage = -85, maxDamage = -110, range = 8, shootEffect = CONST_ANI_ICE, target = false },
	-- drown
	{ name = "condition", type = CONDITION_DROWN, interval = 1000, chance = 45, length = 8, spread = 3, effect = CONST_ME_POFF, target = false },
}
