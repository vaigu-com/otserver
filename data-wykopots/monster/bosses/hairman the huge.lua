...
monster.loot = {
	{ name = "silver raid token", chance = 50000, maxCount = 2 },
	{ name = "platinum coin", chance = 99000, maxCount = 17 },
	{ id = 5883, chance = 90000, maxCount = 10 },
	{ id = 3587, chance = 7500, maxCount = 2 },
	{ id = 3084, chance = 3000 },
	{ id = 3050, chance = 7500 },
	{ id = 3357, chance = 90000 },
}
