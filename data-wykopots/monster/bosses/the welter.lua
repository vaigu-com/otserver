...
monster.loot = {
	...
	{ id = 19356, chance = 5000 },
	{ id = 3369, chance = 25000 },
	{ id = 19357, chance = 8000 },
	{ id = 3079, chance = 15000 },
	{ id = 3436, chance = 20000 },
	{ id = 3284, chance = 20000 },
	{ id = 3029, chance = 50000, maxCount = 2 },
	{ id = 3370, chance = 15000 },
	{ id = 236, chance = 20000, maxCount = 2 },
	{ id = 9302, chance = 10000 },
	{ id = 3081, chance = 25000 },
	{ name = "gold ingot", chance = 18000 },
	{ id = 3392, chance = 20000 },
	{ id = 281, chance = 46000 },
	{ id = 4839, chance = 25000 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 14, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -450, length = 8, spread = 0, effect = CONST_ME_BLACKSMOKE, target = false },
...
monster.defenses = {
	...
	{ name = "the welter heal2", interval = 2000, chance = 8, target = false },
	{ name = "the welter summon2", interval = 2000, chance = 9, target = false },
	{ name = "the welter heal", interval = 2000, chance = 2, target = false },
}
