...
monster.loot = {
	...
	{ id = 20274, chance = 100000, unique = 1 },
	{ name = "platinum coin", chance = 93750, maxCount = 20 },
	{ id = 20277, chance = 6250 },
	{ id = 16126, chance = 6250, maxCount = 3 },
	{ id = 3098, chance = 6250 },
	{ id = 5741, chance = 6250 },
	{ name = "steel boots", chance = 6250 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -1000, maxDamage = -3000, length = 10, spread = 0, effect = CONST_ME_FIREATTACK, target = false },
