...
monster.loot = {
	...
	{ name = "abyss hammer", chance = 3000 },
	{ name = "chaos mace", chance = 6000 },
	{ name = "skull staff", chance = 37000 },
	{ name = "summerblade", chance = 6000 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1000 },
	{ name = "flame strike", interval = 2000, chance = 45, minDamage = -200, maxDamage = -500, target = true },
	{ name = "combat", interval = 2000, chance = 18, type = COMBAT_FIREDAMAGE, minDamage = -700, maxDamage = -2000, length = 8, spread = 0, effect = CONST_ME_FIREAREA, target = false },
	{ name = "combat", interval = 2000, chance = 18, type = COMBAT_FIREDAMAGE, minDamage = -700, maxDamage = -2000, length = 8, spread = 3, effect = CONST_ME_HITBYFIRE, target = false },
}
...
local izcandarSummerTransform = CreatureEvent("IzcandarSummerTransform")
function izcandarSummerTransform.onThink(creature)
	if not creature or not creature:isMonster() then
		return false
	end
	local pos = creature:getPosition()
	if (pos.x >= 6333 and pos.x <= 6340) and (pos.y >= 1949 and pos.y <= 1964) and pos.z == 14 then
...
izcandarSummerTransform:register()
