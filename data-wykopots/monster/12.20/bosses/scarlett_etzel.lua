...
monster.attacks = {
	...
	{ name = "sudden death rune", interval = 2000, chance = 65, minDamage = -500, maxDamage = -800, target = true },
	{ name = "combat", interval = 2000, chance = 22, type = COMBAT_HOLYDAMAGE, minDamage = -450, maxDamage = -700, length = 7, spread = 0, effect = CONST_ME_HOLYAREA, target = false },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -480, maxDamage = -750, radius = 5, effect = CONST_ME_EXPLOSIONHIT, target = false },
}

monster.defenses = {
	defense = 88,
	armor = 88,
	{ name = "combat", type = COMBAT_HEALING, chance = 15, interval = 2000, minDamage = 1000, maxDamage = 3000, effect = CONST_ME_MAGIC_BLUE },
}
