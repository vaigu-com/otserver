...
monster.attacks = {
	...
	{ name = "combat", type = COMBAT_FIREDAMAGE, interval = 2000, chance = 26, length = 8, spread = 0, minDamage = -1200, maxDamage = -3200, effect = CONST_ME_HITBYFIRE },
	{ name = "combat", type = COMBAT_ENERGYDAMAGE, interval = 2000, chance = 26, length = 8, spread = 0, minDamage = -800, maxDamage = -1700, effect = CONST_ME_ENERGYAREA },
	{ name = "combat", type = COMBAT_LIFEDRAIN, interval = 2000, chance = 26, length = 8, spread = 3, minDamage = -600, maxDamage = -1600, effect = CONST_ME_SMALLCLOUDS },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -600, maxDamage = -1200, radius = 5, effect = CONST_ME_EXPLOSIONHIT, target = false },
}
