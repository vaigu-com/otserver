...
monster.summon = {
	maxSummons = 6,
	summons = {
		{ name = "Soulless Minion", chance = 10, interval = 2000, count = 6 },
	},
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 50, type = COMBAT_MANADRAIN, minDamage = -400, maxDamage = -1000, length = 7, spread = 0, effect = CONST_ME_SMALLCLOUDS, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -1000, length = 7, spread = 0, effect = CONST_ME_YELLOW_ENERGY_SPARK, target = false },
