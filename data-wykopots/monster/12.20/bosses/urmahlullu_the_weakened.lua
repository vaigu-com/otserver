...
monster.loot = {
	...
	{ id = 2156, chance = 39000, maxCount = 2 }, -- red gem
	...
	{ name = "tagralt blade", chance = 400 },
	{ name = "winged boots", chance = 400 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 27, type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -800, radius = 4, effect = CONST_ME_FIREAREA, target = false },
	{ name = "combat", interval = 2000, chance = 27, type = COMBAT_FIREDAMAGE, minDamage = -550, maxDamage = -800, radius = 3, effect = CONST_ME_FIREAREA, target = false },
	{ name = "urmahlulluring", interval = 2000, chance = 27, minDamage = -450, maxDamage = -600, target = false },
}
