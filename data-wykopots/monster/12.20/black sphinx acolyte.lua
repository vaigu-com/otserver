...
monster.loot = {
	...
	{ name = "blue crystal shard", chance = 4500 },
	{ name = "snakebite rod", chance = 5600 },
	{ name = "underworld rod", chance = 4300 },
	{ name = "violet gem", chance = 2300 },
	{ name = "opal", chance = 2600, maxCount = 2 },
	{ name = "wand of voodoo", chance = 1600 },
	{ name = "empty honey glass", chance = 2100 },
	{ name = "small enchanted emerald", chance = 1400, maxCount = 3 },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -450, range = 5, radius = 3, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true },
}
