...
monster.loot = {
	...
	{id = 6496, chance = 7000},
	{id = 2992, chance = 7000, maxCount = 5},
	{id = 6276, chance = 7000, maxCount = 3},
	{id = 3586, chance = 7000, maxCount = 3},
	{id = 3598, chance = 7000, maxCount = 5},
	{id = 3590, chance = 7000, maxCount = 4},
	{id = 3585, chance = 700, maxCount = 3},
	{id = 3606, chance = 5000, maxCount = 2},
	{id = 3599, chance = 5000, maxCount = 3},
	{id = 2950, chance = 5000},
	{id = 3147, chance = 5000},
	{id = 3046, chance = 4000},
	{id = 2639, chance = 4000},
	{id = 3056, chance = 4000},
	{id = 2815, chance = 4000},
	{id = 6500, chance = 4000, maxCount = 2},
	{id = 3572, chance = 4000},
	{id = 5890, chance = 4000, maxCount = 5},
	{id = 5894, chance = 4000, maxCount = 3},
	{id = 5902, chance = 4000},
	{id = 4871, chance = 4000},
	{id = 836, chance = 3500, maxCount = 5},
	{id = 841, chance = 3500, maxCount = 100},
	{id = 6392, chance = 1500},
	{id = 6092, chance = 1500},
	{id = 3211, chance = 1500},
	{id = 2995, chance = 1000},
