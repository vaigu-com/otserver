...
local function creatureSayCallback(npc, creature, type, message)
	...
	if (MsgContains(message, "trouble") or MsgContains(message, "problemy")) and player:getStorageValue(Storage.TheInquisition.GrofGuard) < 1 and player:getStorageValue(Storage.TheInquisition.Mission01) ~= -1 then
		npcHandler:say(getPlayerLanguage(player) == "PL" and "Mysle, ze niedlugo zacznie padac, a zostawilem pranie na zewnatrz.." or "I think it'll rain soon and I left some laundry out for drying.", npc, creature)
