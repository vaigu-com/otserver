...
npcHandler:setMessage(MESSAGE_GREET, "Dzien dobry! Wygladasz na glodnego.. Wpisz {trade} aby zobaczyc oferte.")
-- npcHandler:setMessage(MESSAGE_GREET_ENG, 'Hello! You look really hungry.. Ask about {trade} to see my offer.')
