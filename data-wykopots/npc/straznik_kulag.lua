...
local function creatureSayCallback(npc, creature, type, message)
	...
	if (MsgContains(message, "trouble") or MsgContains(message, "problemy")) and player:getStorageValue(Storage.TheInquisition.KulagGuard) < 1 and player:getStorageValue(Storage.TheInquisition.Mission01) ~= -1 then
		npcHandler:say(getPlayerLanguage(player) == "PL" and "Poszukiwacze przygod, jak ty, staja sie coraz bardziej uciazliwi." or "You adventurers become more and more of a pest.", npc, creature)
