...
npcHandler:setMessage(MESSAGE_GREET, "Witam, skupuje wszelkiego rodzaju miecze, tarcze, zbroje i inne tego typu przedmioty. Wpisz {trade} aby zobaczyc moja oferte.")
npcHandler:setMessage(MESSAGE_FAREWELL, "Narazie!")
npcHandler:setMessage(MESSAGE_WALKAWAY, "Nie to nie, #usunkonto!")
-- npcHandler:setMessage(MESSAGE_GREET_ENG, 'Hello, need a deal in weapons or armor? Say {trade} to see what exactly Im talking about.')
-- npcHandler:setMessage(MESSAGE_FAREWELL_ENG, 'Bye!')
-- npcHandler:setMessage(MESSAGE_WALKAWAY_ENG, 'Well, go away..')
