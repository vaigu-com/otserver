...
function broadcastMessage(message, messageType, translate)
	Game.broadcastMessage(message, messageType, translate)
...
LANG_ABBREVIATION_TO_FULL_NAME = { ["PL"] = "Polski", ["EN"] = "English" }

LANGUAGE_NAMES = { PL = "PL", EN = "EN" }
LANGUAGES = LANGUAGE_NAMES

LANG_FULL_NAME_TO_ABBREVIATION = {}
for abbreviation, fullName in pairs(LANG_ABBREVIATION_TO_FULL_NAME) do
	LANG_FULL_NAME_TO_ABBREVIATION[fullName] = abbreviation
end
...
function getPlayerLanguage(cidOrPlayer)
	local player = Player(cidOrPlayer)
