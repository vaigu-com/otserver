			...
			if player:getPosition().x == pushPos.x and player:getPosition().y == pushPos.y and player:getPosition().z == pushPos.z then
				...
				if doCheckArea() == false then
					...
					for i = 1, #storeHunger do
						...
						teamHunger:setEncounterLockout("World Devourer", os.time() + 7 * 24 * 60 * 60)
					...
					for i = 1, #storeDestruction do
						...
						teamDestruction:setEncounterLockout("World Devourer", os.time() + 7 * 24 * 60 * 60)
					...
					for i = 1, #storeRage do
						...
						teamRage:setEncounterLockout("World Devourer", os.time() + 7 * 24 * 60 * 60)
