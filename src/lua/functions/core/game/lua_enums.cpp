...
void LuaEnums::initOthersEnums(lua_State* L) {
	...
	registerGlobalString(L, "STORAGEVALUE_EMOTE", STORAGEVALUE_EMOTE);
	registerGlobalString(L, "STORAGEVALUE_PODIUM", STORAGEVALUE_PODIUM);
	registerGlobalString(L, "STORAGEVALUE_BESTIARYKILLCOUNT", STORAGEVALUE_BESTIARYKILLCOUNT);
	registerGlobalString(L, "STORAGEVALUE_GIFT_OF_LIFE_COOLDOWN_WOD", STORAGEVALUE_GIFT_OF_LIFE_COOLDOWN_WOD);
