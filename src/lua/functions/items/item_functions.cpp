...
void ItemFunctions::init(lua_State* L) {
	...
	Lua::registerMethod(L, "Item", "getDescription", ItemFunctions::luaItemGetDescription); // Vaigu custom
	Lua::registerMethod(L, "Item", "getNameDescription", ItemFunctions::luaItemGetNameDescription); // Vaigu custom
