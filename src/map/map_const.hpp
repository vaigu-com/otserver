...
static constexpr int32_t MAP_MAX_CLIENT_THROW_RANGE_X = MAP_MAX_CLIENT_VIEW_PORT_X + 1; // Vaigu custom
static constexpr int32_t MAP_MAX_CLIENT_THROW_RANGE_Y = MAP_MAX_CLIENT_VIEW_PORT_Y + 1; // Vaigu custom
