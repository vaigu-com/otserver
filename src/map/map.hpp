...
public:
	 ...
	 */
	bool canThrowObjectTo(const Position &fromPos, const Position &toPos, SightLines_t lineOfSight = SightLine_CheckSightLine, int32_t rangex = MAP_MAX_CLIENT_THROW_RANGE_X, int32_t rangey = MAP_MAX_CLIENT_THROW_RANGE_X);
	/**
